$(function () {
    ...
    $(".J_menuItem").click(function () {
        ...
        if (k) {
            ...
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="791" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
    ...
    function fresh(e, c) {
        if (c == "e") {
            $(".J_mainContent .J_iframe").each(function () {
                if ($(this).data("id") == e.attr("data-id")) {
                    $(this).attr('src', e.attr("data-id"));
            ...
            $(".J_mainContent .J_iframe").each(function () {
                if ($(this).data("id") == e.attr("href")) {
                    $(this).attr('src', e.attr("href"));
                    $(this).attr('data-id', e.attr("href"));
                    return false
                }
            })
        }

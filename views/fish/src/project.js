require = function t(e, n, i) {
    ...
    Alert: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "f8797cri4pJjLK4zWGl0jXd", "Alert"),
        cc.Class({
            ...
            research: function() {
                ...
                this._title = cc.find("Canvas/alert/commonBg/title").getComponent(cc.Label),
                this._content = cc.find("Canvas/alert/commonBg/content").getComponent(cc.Label),
                this._btnOK = cc.find("Canvas/alert/commonBg/btn_ok"),
                this._btnCancel = cc.find("Canvas/alert/commonBg/btn_cancel"),
                cc.yqs.utils.addClickEvent(this._btnOK, this.node, "Alert", "onBtnClicked"),
                cc.yqs.utils.addClickEvent(this._btnCancel, this.node, "Alert", "onBtnClicked")
            },
            onBtnClicked: function(t) {
                "btn_ok" == t.target.name && this._onok && this._onok(),
                this._alert.active = !1,
                this._onok = null
            },
            show: function(t, e, n, i) {
                this._alert || this.research(),
                this._alert.active = !0,
                this._onok = n,
                this._title.string = t,
                this._content.string = e,
                i ? (this._btnCancel.active = !0, this._btnOK.x = -150, this._btnCancel.x = 150) : (this._btnCancel.active = !1, this._btnOK.x = 0)
            },
            onDestory: function() {
    ...
    AudioMgr: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "5b374dUnOdJYb24jcvI8m1t", "AudioMgr"),
        cc.Class({
            extends: cc.Component,
            properties: {
                bgmVolume: 1,
            ...
            init: function() {
                ...
                null != (t = cc.sys.localStorage.getItem("sfxVolume")) && (this.sfxVolume = parseFloat(t)),
            ...
            setBGMVolume: function(t, e) {
                ...
                (this.bgmVolume != t || e) && (cc.sys.localStorage.setItem("bgmVolume", t), this.bgmVolume = t, cc.audioEngine.setVolume(this.bgmAudioID, t))
            },
            pauseAll: function() {
                cc.audioEngine.pauseAll()
            },
    ...
    Bggems: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "b670bECMvJA54XxhGRHMFmp", "Bggems"),
        cc.Class({
            extends: cc.Component,
            properties: {
                lblgems: cc.Label
    ...
    BulletManager: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "2761ftpellC9JHJlxHl7y91", "BulletManager"),
        cc.Class({
            extends: cc.Component,
            properties: {
                bomb: {
            ...
            onLoad: function() {
                cc.yqs.bomb = this.bomb,
                cc.yqs.bulletMgr = this,
                this.playerArray = [],
                this.aliveBullet = {}
            },
            start: function() {
            ...
            createBulletWithCannon: function(t, e) {
                ...
                return null != o && i.getComponent("Cannon") && o.initWithAngle(i.getComponent("Cannon").angle, e, t),
                this.playerArray[t - 1].push(n),
                n
            },
            createLaserBulletWithCannon: function(t, e) {
                ...
                return null != o && i.getComponent("Cannon") && o.initlaserWithAngle(i.getComponent("Cannon").angle, 22, t),
                n
            },
            getBolt: function() {
            ...
            destroyBullet: function(t) {
                if (this.aliveBullet[t]) {
                    ...
                    n.status = 0,
                    e.removeFromParent(),
                    cc.js.array.contains(this.playerArray[n.chairId - 1], e) && cc.js.array.remove(this.playerArray[n.chairId - 1], e),
                    cc.yqs.nodepool.putBulletById(e, n.type),
                    delete this.aliveBullet[n.id]
                }
            },
            ...
            showBombPanel: function(t) {
                var e = function() {
                    cc.yqs.bomb.getComponent(cc.Animation).stop(),
                    cc.yqs.bomb.active = !1
                };
                cc.yqs.bomb.active = !0,
                cc.yqs.bomb.getComponent("bomb").setScore(t),
                cc.yqs.bomb.getComponent(cc.Animation).play(),
                this.unschedule(e),
                this.scheduleOnce(e, 5);
    ...
    Bullet: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "acfd0xeRKZDG5wrIQLOtzye", "Bullet"),
        cc.Class({
            extends: cc.Component,
            properties: {},
            onLoad: function() {
            ...
            initWithAngle: function(t, e, n) {
                ...
                this.status = 1,
                this.chairId = n,
                cc.yqs.mathutil.needViewTrans() ? n <= 2 && (t += 180) : n > 2 && (t += 180),
                this.angle = t,
                this.startMove(t)
            },
            ...
            playWeb: function() {
                ...
                this.status = 2,
                this.node.getComponent(cc.Animation).play("web" + this.type)
            },
            setLockFish: function(t) {
                if (1 == this.status) {
                    this.lockFish;
                    this.lockFish && !t ? this.startMove(this.angle) : t && this.node.stopAllActions(),
                    this.lockFish = t
                }
            },
            ...
            putBulletToPool: function() {
                this.lockFish = null,
                cc.yqs.bulletMgr.destroyBullet(this.id),
                this.id = 0
            },
            ...
            update: function(t) {
                if (null != this.lockFish) {
                    ...
                    if (1 == e.status && 1 == this.status) {
                        ...
                        cc.pToAngle(o),
                        Math.PI;
                        this.angle = -1 * (cc.yqs.mathutil.redian2angle(cc.pToAngle(o)) - 90),
    ...
    1 : [function(t, e, n) {
        ...
        function o(t, e, n) {
            for (var i, o = [], r = e; r < n; r += 3) i = (t[r] << 16) + (t[r + 1] << 8) + t[r + 2],
            o.push(s(i));
            return o.join("")
        }
        ...
        n.toByteArray = function(t) {
            ...
            n = o > 0 ? h - 4 : h;
            var l = 0;
            for (e = 0; e < n; e += 4) s = c[t.charCodeAt(e)] << 18 | c[t.charCodeAt(e + 1)] << 12 | c[t.charCodeAt(e + 2)] << 6 | c[t.charCodeAt(e + 3)],
            r[l++] = s >> 16 & 255,
            r[l++] = s >> 8 & 255,
            r[l++] = 255 & s;
            return 2 === o ? (s = c[t.charCodeAt(e)] << 2 | c[t.charCodeAt(e + 1)] >> 4, r[l++] = 255 & s) : 1 === o && (s = c[t.charCodeAt(e)] << 10 | c[t.charCodeAt(e + 1)] << 4 | c[t.charCodeAt(e + 2)] >> 2, r[l++] = s >> 8 & 255, r[l++] = 255 & s),
            r
        },
        n.fromByteArray = function(t) {
            ...
            i = n % 3,
            s = "",
            c = [], a = 0, h = n - i; a < h; a += 16383) c.push(o(t, a, a + 16383 > h ? h: a + 16383));
            return 1 === i ? (e = t[n - 1], s += r[e >> 2], s += r[e << 4 & 63], s += "==") : 2 === i && (e = (t[n - 2] << 8) + t[n - 1], s += r[e >> 10], s += r[e >> 4 & 63], s += r[e << 2 & 63], s += "="),
            c.push(s),
            c.join("")
        };
        for (var r = [], c = [], a = "undefined" != typeof Uint8Array ? Uint8Array: Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", l = 0, u = h.length; l < u; ++l) r[l] = h[l],
        c[h.charCodeAt(l)] = l;
        c["-".charCodeAt(0)] = 62,
        c["_".charCodeAt(0)] = 63
    },
    {}],
    2 : [function(t, e, n) { (function(e) {
            "use strict";
            function i() {
            ...
            function s(t, e) {
                ...
                return o.TYPED_ARRAY_SUPPORT ? (t = new Uint8Array(e)).__proto__ = o.prototype: (null === t && (t = new o(e)), t.length = e),
                t
            }
            function o(t, e, n) {
            ...
            function v(t, e, n, i, s) {
                ...
                o.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? s ? Uint8Array.prototype.indexOf.call(t, e, n) : Uint8Array.prototype.lastIndexOf.call(t, e, n) : _(t, [e], n, i, s);
                ...
                for (var i = [], s = e; s < n;) {
                    ...
                    if (s + c <= n) {
                        ...
                        case 3:
                            a = t[s + 1],
                            h = t[s + 2],
                            128 == (192 & a) && 128 == (192 & h) && (u = (15 & o) << 12 | (63 & a) << 6 | 63 & h) > 2047 && (u < 55296 || u > 57343) && (r = u);
                            break;
                        case 4:
                            a = t[s + 1],
                            h = t[s + 2],
                            l = t[s + 3],
                            128 == (192 & a) && 128 == (192 & h) && 128 == (192 & l) && (u = (15 & o) << 18 | (63 & a) << 12 | (63 & h) << 6 | 63 & l) > 65535 && u < 1114112 && (r = u)
                        }
                    }
                    null === r ? (r = 65533, c = 1) : r > 65535 && (r -= 65536, i.push(r >>> 10 & 1023 | 55296), r = 56320 | 1023 & r),
                    i.push(r),
                    s += c
                }
                return P(i)
            ...
            function P(t) {
                ...
                for (var n = "",
                i = 0; i < e;) n += String.fromCharCode.apply(String, t.slice(i, i += Z));
                return n
            }
            function S(t, e, n) {
                var i = "";
            ...
            function E(t, e, n, i) {
                e < 0 && (e = 65535 + e + 1);
                for (var s = 0,
                o = Math.min(t.length - n, 2); s < o; ++s) t[n + s] = (e & 255 << 8 * (i ? s: 1 - s)) >>> 8 * (i ? s: 1 - s)
            }
            function L(t, e, n, i) {
                e < 0 && (e = 4294967295 + e + 1);
                for (var s = 0,
                o = Math.min(t.length - n, 4); s < o; ++s) t[n + s] = e >>> 8 * (i ? s: 3 - s) & 255
            }
            ...
            function O(t, e, n, i, s) {
                return s || N(t, e, n, 4, 3.4028234663852886e38, -3.4028234663852886e38),
                X.write(t, e, n, i, 23, 4),
                n + 4
            }
            function D(t, e, n, i, s) {
                return s || N(t, e, n, 8, 1.7976931348623157e308, -1.7976931348623157e308),
                X.write(t, e, n, i, 52, 8),
                n + 8
            }
            function U(t) {
                ...
                o = [], r = 0; r < i; ++r) {
                    if ((n = t.charCodeAt(r)) > 55295 && n < 57344) {
                        if (!s) {
                            ...
                            if (r + 1 === i) { (e -= 3) > -1 && o.push(239, 191, 189);
                                continue
                            }
                            s = n;
                            continue
            ...
            function G(t, e) {
                for (var n, i, s, o = [], r = 0; r < t.length && !((e -= 2) < 0); ++r) i = (n = t.charCodeAt(r)) >> 8,
                s = n % 256,
                o.push(s),
                o.push(i);
                return o
            ...
            o.compare = function(t, e) {
                ...
                i = e.length,
                s = 0,
                r = Math.min(n, i); s < r; ++s) if (t[s] !== e[s]) {
                    n = t[s],
                    i = e[s];
                    break
                }
            ...
            o.prototype.compare = function(t, e, n, i, s) {
                ...
                for (var r = s - i,
                c = n - e,
                a = Math.min(r, c), h = this.slice(i, s), l = t.slice(e, n), u = 0; u < a; ++u) if (h[u] !== l[u]) {
                    r = h[u],
                    c = l[u];
                    break
                }
            ...
            o.prototype.readIntBE = function(t, e, n) {
                ...
                for (var i = e,
                s = 1,
                o = this[t + --i]; i > 0 && (s *= 256);) o += this[t + --i] * s;
                return s *= 128,
                o >= s && (o -= Math.pow(2, 8 * e)),
                o
            },
            ...
            o.prototype.writeUInt16LE = function(t, e, n) {
                ...
                o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : E(this, t, e, !0),
                e + 2
            },
            o.prototype.writeUInt16BE = function(t, e, n) {
                ...
                e |= 0,
                n || R(this, t, e, 2, 65535, 0),
                o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : E(this, t, e, !1),
                e + 2
            },
            ...
            o.prototype.writeIntLE = function(t, e, n, i) {
                ...
                r = 1,
                c = 0;
                for (this[e] = 255 & t; ++o < n && (r *= 256);) t < 0 && 0 === c && 0 !== this[e + o - 1] && (c = 1),
                this[e + o] = (t / r >> 0) - c & 255;
                return e + n
            },
            o.prototype.writeIntBE = function(t, e, n, i) {
                ...
                r = 1,
                c = 0;
                for (this[e + o] = 255 & t; --o >= 0 && (r *= 256);) t < 0 && 0 === c && 0 !== this[e + o + 1] && (c = 1),
                this[e + o] = (t / r >> 0) - c & 255;
                return e + n
            },
            ...
            o.prototype.copy = function(t, e, n, i) {
                ...
                var s, r = i - n;
                if (this === t && n < e && e < i) for (s = r - 1; s >= 0; --s) t[s + e] = this[s + n];
                else if (r < 1e3 || !o.TYPED_ARRAY_SUPPORT) for (s = 0; s < r; ++s) t[s + e] = this[s + n];
    ...
    Cannon: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "9c4a1C5sMpHGLYuQhmEcp3v", "Cannon"),
        cc.Class({
            extends: cc.Component,
            properties: {
                emptyNode: cc.Node,
            ...
            onLoad: function() {
                ...
                this._score = 0,
                this.beforeId = 0,
                this.onescheduletime = 31,
                this.onLasrmove = !1,
                this.round = cc.instantiate(this.CannonRound)
            },
            ...
            clearSeat: function() {
                ...
                this.cannonPlatform.active = !1,
                this.selfPlatform.active = !1,
                cc.yqs.bulletMgr.removeBulletsByChairId(this.chairId)
            },
            onEnable: function() {
            ...
            setAngle: function(t) {
                ...
                return t.y >= e.y && (s = cc.yqs.mathutil.redian2angle( - 1 * Math.acos(i)) + 90),
                this.spr.rotation = s,
                this.angle = s,
                s
            },
            onFire: function(t, e) {
                if (! (this.onLasrmove || this.fireTime < .15)) {
                    if (this.fireTime = 0, t && (this.angle = this.setAngle(t)), cc.yqs.userMgr.gems < cc.yqs.bulletMgr.getBulletMulti(this.CannonKind) * cc.yqs.gameMgr.sceneMulti) return this.unLockFish(),
                    this.rewardNode.active && (this.rewardNode.active = !1),
                    this.unscheduleAllCallbacks(),
                    void cc.yqs.alert.show("", "余额不足",
                    function() {});
                    var n = this.CannonKind,
                    i = cc.yqs.bulletMgr.createBulletWithCannon(this.chairId, n);
                    if (i) {
                        c = this.chairId + "_" + (new Date).getTime() % 6e5;
                        i.getComponent("Bullet").setBulletId(c),
                        cc.yqs.bulletMgr.aliveBullet[c] = i;
                        var s = 0;
                        ...
                        c = c,
                        a = this.angle;
                        cc.yqs.gameMgr.send_user_fire(o, r, n, c, a, s),
                        this.reduceCoin(cc.yqs.bulletMgr.getBulletMulti(this.CannonKind) * cc.yqs.gameMgr.sceneMulti);
                        if (cc.yqs.audioMgr.playSFX("common_fire.mp3"), cc.find("cannon", this.spr).getComponent(cc.Animation).play("cannon" + this.cannonId), this.powerBar.progress < 1) {
                            ...
                            this.powerBar.progress += h,
                            this.powerBar.progress >= 1 && !this.laser.active && this.showLasrTip()
            ...
            addCoin: function(t) {
                var e = this._score;
                this._score = parseFloat(e) + parseFloat(t),
                this.CoinLabel.string = cc.yqs.utils.transString(parseFloat(this._score).toFixed(3)) + ":"
            },
            ...
            onAddClick: function() {
                ...
                cc.yqs.net.send("user_change_cannon", i),
                this.onCannonChange(n)
            },
            ...
            setAuto: function(t) {
                this.onAuto = t,
                this.fireToggle && (this.fireToggle.isChecked = t)
            },
            setLock: function(t) {
            ...
            onAutoFireToggle: function(t) {
                this.onAuto = t.isChecked,
                t.isChecked ? (this.onUnLockFish(), this.onAutoFire()) : this.onAutoFire()
            },
            ...
            onFrazen: function() {
                if (cc.yqs.gameMgr.frozen) cc.yqs.alert.show("", "冷冻中");
                    ...
                    cc.yqs.net.send("user_frozen", t),
                    cc.yqs.gameMgr.onFrozenScene(),
                    this.frozenCD.node.active = !0,
                    this.frozenCD.progress = 1,
                    this.frozenBtn.enabled = !1
                }
            },
            drawLockLine: function(t) {
                var e = cc.yqs.utils.convertPos(this.node, this.firePos, t);
                if (this.lockFish) for (var n = cc.yqs.mathutil.getAngleByPos(cc.p(0, 0), e), i = cc.pDistance(cc.p(0, 0), e) / 6, s = i * Math.cos(cc.yqs.mathutil.angle2radian(n)), o = i * Math.sin(cc.yqs.mathutil.angle2radian(n)), r = 1; r <= this.lockLinePoints.length; r++) this.lockLinePoints[r - 1].position = cc.p(s * r, o * r),
                this.lockLinePoints[r - 1].active || (this.lockLinePoints[r - 1].active = !0)
            },
                ...
                if (this.CannonKind != e && (this.CannonKind = e, this.setCannon(this.CannonKind)), 22 != this.CannonKind) {
                    if (! (this.fireTime < .15)) {
                        ...
                        if (o) {
                            ...
                            return cc.yqs.audioMgr.playSFX("common_fire.mp3"),
                            cc.find("cannon", this.spr).getComponent(cc.Animation).play("cannon" + this.cannonId),
                            o
                        }
                    }
            ...
            onCatchFish: function(t, e, n) {
                self = this,
                this.addCoin(e),
                this.lockFish && (this.setLock(null), this.onUnLockFish()),
                this.columnMgr && this.columnMgr.getComponent("GoldColimnManager") && this.columnMgr.getComponent("GoldColimnManager").pushScore(e, this.chairId);
                var i = n.kind,
                s = {
                    23 : 3,
                    24 : 3,
            ...
            showCatchPanel: function(t, e) {
                ...
                var i = function() {
                    n.rewardNode.getComponentInChildren(cc.Animation).stop(),
                    n.rewardNode.active = !1
                };
                this.rewardNode.active = !0,
                this.rewardNode.getComponentInChildren(cc.Animation).play(),
                this.rewardNode.getComponent("RewardFish").playReward(t, e),
                this.unschedule(i),
            ...
            onAutoFire: function() {
                ...
                this.schedule(function e() {
                    this.onAuto || t.unschedule(e),
                    22 != this.CannonKind && this.onFire()
                },
                .16)
            },
            onLockFish: function(t, e) {
                if (this.onUnLockFish(), 22 != this.CannonKind && t) {
                    ...
                    if (null != n && (n.lockPos.active = !0, n.locked = !0), this.setLock(t), this.setAuto(!1), cc.yqs.bulletMgr.lockFish(this.chairId, t), e == cc.yqs.userMgr.userId) {
                        ...
                        cc.yqs.net.send("user_lock_fish", s),
                        this.schedule(this.fireLock, .16)
                    }
                    this.node.addChild(this.round),
                    this.round.setPosition(0, 0),
                    this.round.getComponent(cc.Animation).play()
                }
            },
            fireLock: function() {
                var t = this.lockFish,
            ...
            onUnLockFish: function() {
                ...
                this.setLock(null),
                cc.yqs.bulletMgr.unLockFish(this.chairId),
                this.unschedule(this.fireLock),
                this.round.getComponent(cc.Animation).stop(),
            ...
            showLasrTip: function() {
                ...
                if (! (this.chairId != cc.yqs.userMgr.chairId || this.powerBar.progress < 1)) {
                    this.laser.active = !0,
                    this.laser.getComponent(cc.Animation).play();
                    this.laser.runAction(cc.sequence(cc.delayTime(5), cc.callFunc(function() {
                        t.laser.getComponent(cc.Animation).stop(),
                        t.laser.active = !1
                    }))),
            ...
            onCannonClick: function() {
                ...
                if (! (this.chairId == cc.yqs.userMgr.chairId && this.powerBar.progress < 1) && (this.onUnLockFish(), 22 != this.CannonKind)) {
                    this.beforeId = this.CannonKind,
                    this.CannonKind = 22;
                    var e = cc.find("cannon", this.spr);
                    this.onLasrmove = !0;
                    if (e && e.runAction(cc.sequence(cc.moveBy(2, cc.p(0, -130)), cc.callFunc(function() {
                        e.removeFromParent(),
                        cc.yqs.nodepool.putCannonById(e, t.cannonId);
                        var n = cc.yqs.nodepool.getCannonById(22);
                        n.name = "cannon",
                        t.spr.addChild(n),
                        n.anchorY = 0,
                        n.position = cc.p(0, -130),
                        n.runAction(cc.sequence(cc.moveBy(2, cc.p(0, 130)), cc.callFunc(function() {
                            t.onLasrmove = !1
                        })))
                    }))), cc.yqs.userMgr.chairId == this.chairId) {
                        this.reduce.interactable = !1,
                        this.add.interactable = !1,
                        this.spr.getComponent(cc.Button).enabled = !1;
                        var n = {
                            userId: cc.yqs.userMgr.userId,
                            chairId: cc.yqs.userMgr.chairId,
                    ...
                    this.schedule(function e() {
                        t.bulletLabel.string = --t.onescheduletime,
                        0 == t.onescheduletime && t.laserOnfire(t.angle),
                        (t.onescheduletime <= 0 || 22 != t.CannonKind) && (t.unschedule(e), t.setSceneMulti(), t.onescheduletime = 30)
                    },
                    1, 30, 3)
                }
            },
            laserOnfire: function(t) {
                ...
                if (!this.onLasrmove && !(this.chairId == cc.yqs.userMgr.chairId && this.powerBar.progress < 1 || this.CannonKind < 22)) {
                    ...
                    if (s && s.runAction(cc.sequence(cc.delayTime(3), cc.moveBy(2, cc.p(0, -130)), cc.callFunc(function() {
                        e.onescheduletime = 31,
                        n.removeFromParent(),
                        cc.yqs.nodepool.putBulletById(n, i.type),
                        e.CannonKind = e.beforeId,
                        s.removeFromParent(),
                        cc.yqs.nodepool.putCannonById(s, 22),
                        e.onLasrmove = !0;
                        var t = cc.yqs.nodepool.getCannonById(e.CannonKind);
                        t.name = "cannon",
                        e.spr.addChild(t),
                        t.anchorY = 0,
                        t.position = cc.p(0, -130),
                        t.runAction(cc.sequence(cc.moveBy(2, cc.p(0, 130)), cc.callFunc(function() {
                        ...
                        this.reduce.interactable = !0,
                        this.add.interactable = !0;
                        var o = cc.yqs.userMgr.userId,
                        r = cc.yqs.userMgr.chairId,
                        t = this.angle;
            ...
            getNewItem: function() {
                ...
                t.parent = this.node,
                t.position = cc.yqs.utils.convertPos(cc.yqs.fishMgr.node, this.node, cc.p(0, 0)),
                this.frozenBtn.node.runAction(cc.sequence(cc.scaleTo(.2, 1.2), cc.scaleTo(.2, 1), cc.scaleTo(.2, 1.2), cc.scaleTo(.2, 1))),
                t.runAction(cc.sequence(cc.moveTo(.5, cc.p(0, 0)), cc.callFunc(function() {
                    t.destroy()
                })))
            }
        }),
    ...
    Chat: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "7660bGk3ydGTY4xcs2ocvWa", "Chat"),
        cc.Class({
            extends: cc.Component,
            properties: {
                _chatRoot: null,
            ...
            onLoad: function() {
                null != cc.yqs && (cc.yqs.chat = this, this._btnChat = this.node.getChildByName("btn_chat"), this._btnChat.active = !0, this._chatRoot = this.node.getChildByName("chat"), this._chatRoot.active = !1, this._tabQuick = this._chatRoot.getChildByName("quickchatlist"), this._tabEmoji = this._chatRoot.getChildByName("emojis"), this._iptChat = this._chatRoot.getChildByName("iptChat").getComponent(cc.EditBox), this._quickChatInfo = {},
            ...
            onEmojiItemClicked: function(t) {
                ...
                this._chatRoot.active = !1,
                cc.yqs.net.send("emoji", t.target.name)
            },
            onBtnSendChatClicked: function() {
                this._chatRoot.active = !1,
                "" != this._iptChat.string && (cc.yqs.net.send("chat", this._iptChat.string), this._iptChat.string = "")
            }
        }),
        cc._RF.pop()
    },
    ...
    Coin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "0bf4bJguA5LnJgFdxwfs7Ed", "Coin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                kind: {
            ...
            initWithKind: function(t, e, n) {
                if (null != e) {
                    ...
                    this.node.position = cc.p(n.position.x + i, n.position.y),
                    this.kind = t;
            ...
            bombplay: function(t, e) {
                this.kind = e,
                this.node.parent = cc.yqs.bulletMgr.node,
                this.node.position = cc.p(100 - 200 * Math.random(), 200),
                this.node.scale = .5;
            ...
            putCoinToPool: function() {
                ...
                cc.yqs.nodepool.putCoinById(t.node, t.kind)
            },
            getNode: function() {
                cc.find("Canvas/../..");
                var t = cc.yqs.roomMgr.getPlayerByIndex(chairId);
                cc.find("platform1/gemsBg/moneyIcon", t),
                t.getChi
            }
        }),
        cc._RF.pop()
    ...
    CreateRole: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "c10a3UZn+RCH6iuE0b4wkvC", "CreateRole"),
        cc.Class({
            extends: cc.Component,
            properties: {
    ...
    Demo: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "7d724rD4A5Mx4mTI7h9pWcr", "Demo"),
        cc.Class({
            extends: cc.Component,
            properties: {
                mainbg: cc.Sprite,
    ...
    {}],
    EasePack: [function(t, e, n) { (function(n) {
            "use strict";
            cc._RF.push(e, "e7f6cgm00BD+YX+UMK+VKca", "EasePack");
            var i = void 0 !== e && e.exports && void 0 !== n ? n: window; (i._gsQueue || (i._gsQueue = [])).push(function() {
                ...
                function(t) {
                    ...
                    function(e) {
                        for (var n, i, s, o, r, c, a = (e = e || {}).taper || "none", h = [], l = 0, u = 0 | (e.points || 20), f = u, p = !1 !== e.randomize, g = !0 === e.clamp, m = e.template instanceof t ? e.template: null, y = "number" == typeof e.strength ? .4 * e.strength: .4; --f > -1;) n = p ? Math.random() : 1 / u * f,
                        i = m ? m.getRatio(n) : n,
                        s = "none" === a ? y: "out" === a ? (o = 1 - n) * o * y: "in" === a ? n * n * y: n < .5 ? (o = 2 * n) * o * .5 * y: (o = 2 * (1 - n)) * o * .5 * y,
                        p ? i += Math.random() * s - .5 * s: f % 2 ? i += .5 * s: i -= .5 * s,
                        g && (i > 1 ? i = 1 : i < 0 && (i = 0)),
                        h[l++] = {
                            x: n,
                            y: i
                        ...
                        for (h.sort(function(t, e) {
                            return t.x - e.x
                        }), c = new d(1, 1, null), f = u; --f > -1;) r = h[f],
                        c = new d(r.x, r.y, c);
    ...
    EmailWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "48461WdWYBIvLwsG/PXcMZ/", "EmailWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node
    ...
    FishGameMananger: [function(t, e, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                cc.yqs.gameMgr = this,
                this.initCollision(),
                cc.yqs.audioMgr.playBGM("bgm2.mp3"),
                this.sceneId = 0,
                this.frozen = !1,
                this.frozenTime = 10,
                this.formation = !1,
            ...
            onChangeScene: function() {
                ...
                i.active = !0,
                this.frozenSceneBg.spriteFrame = this.frozenBgs[this.sceneId];
                var s = !1;
                this.schedule(function() {
            ...
            onFrozenScene: function(t) {
                var e = this;
                this.frozen = !0,
                this.frozenTime = t ? t / 1e3: 10,
                this.frozenSceneBg.node.active = !0,
                this.frozenSceneBg.spriteFrame = this.frozenBgs[this.sceneId];
            ...
            onCatchFishArray: function(t, e, n, i) {
                ...
                cc.yqs.audioMgr.playSFX("SilverCoin.mp3"),
                cc.yqs.fishMgr.onCatchFishArray(e, t)
            },
            onLockFish: function(t, e) {
            ...
            playmouse: function(t) {
                ...
                e.runAction(cc.sequence(cc.delayTime(.5), cc.callFunc(function() {
                    e.getComponent(cc.Animation).play(),
                    e.removeFromParent()
                })))
            },
            send_user_fire: function(t, e, n, s, o, r) {
                ...
                c.sign = i.md5(t + e + n + s + o + r),
                cc.yqs.net.send("user_fire", c)
            },
            send_catch_fish: function(t, e, n, s) {
                ...
                o.sign = i.md5(t + e + n + s),
                cc.yqs.net.send("catch_fish", o)
            },
            send_laser_catch_fish: function(t, e, n) {
                ...
                s.sign = i.md5(t + e + s.fishes),
                cc.yqs.net.send("laser_catch_fish", s)
            }
        }),
        cc._RF.pop()
    },
    ...
    FishManager: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "b4cc9j2qKdHbZS9jQwB03b2", "FishManager"),
        cc.Class({
            extends: cc.Component,
            properties: {
                Pools: cc.Node,
            ...
            initNodePool: function() {
                ...
                cc.yqs.nodepool = t,
                null != cc.yqs.nodepool && cc.yqs.nodepool.InitPool()
            },
            onEnable: function() {
                cc.yqs.eventCenter.addEvent(this, "build_fish", this.activeFish),
                cc.yqs.eventCenter.addEvent(this, "build_fishArray_reply", this.fishArrayStart)
            },
            onDisable: function() {
                cc.yqs.eventCenter.removeEvent(this, "build_fish", this.activeFish),
                cc.yqs.eventCenter.removeEvent(this, "build_fishArray_reply", this.fishArrayStart)
            },
            activeFish: function(t) {
                if (!cc.yqs.gameMgr.frozen) for (var e = 0; e < t.detail.length; e++) {
                    ...
                    if (!this.aliveFish.hasOwnProperty(o)) {
                        ...
                        this.node.addChild(c, 100),
                        c.setPosition(cc.v2( - 1e3, -1e3));
                        var a = c.getComponent("Fish");
                        a.setFishId(o),
                        a.setFishSpeed(r),
                        a.initWithTrackId(s, i),
                        this.aliveFish[o] = c
                    }
                }
            },
            ...
            destroyFish: function(t) {
                if (this.aliveFish[t]) {
                    ...
                    e.removeFromParent(),
                    cc.yqs.nodepool.putFishById(e, n.kind),
                    delete this.aliveFish[t]
            ...
            showfishArray1: function(t) {
                ...
                s = function() {
                    if (!cc.yqs.gameMgr.frozen) {
                        ...
                        this.node.addChild(o, 100),
                        o.setPosition(i.pos),
                        o.rotation = i.angle;
                        var r = o.getComponent("Fish");
                        r.InitWithAngle(i.angle, s),
                        r.setFishId(n.fishId),
                        this.aliveFish[n.fishId] = o
                    }
                };
                this.schedule(function i() {
                    if (!cc.yqs.gameMgr.frozen) {
                        if (30 == ++e) return this.unschedule(i),
                        this.unschedule(s),
                        void this.scheduleOnce(this.fishArrayEnd, 10);
                        var o = t[0][e],
                        r = o.fishKind,
                        ...
                        c.rotation = n.angle;
                        var a = c.getComponent("Fish");
                        a.InitWithAngle(n.angle, r),
                        a.setFishId(o.fishId),
                        e > 20 && console.log("fishId:: " + o.fishId),
                        this.aliveFish[o.fishId] = c
                    }
                },
                2, 1e3, 3),
                this.schedule(s, 2, 1e3, 3)
            },
                ...
                this.schedule(function i() {
                    if (! (cc.yqs.gameMgr.frozen || e.length <= 0)) {
                        for (var s = e.slice(), o = t[n], r = 0; r < o.length; r++) {
                            ...
                            this.node.addChild(c, 100),
                            c.setPosition(s[r].pos),
                            c.rotation = s[r].angle;
                            var a = c.getComponent("Fish");
                            a.InitWithAngle(s[r].angle, o[r].fishKind),
                            a.setFishId(o[r].fishId),
                            this.aliveFish[o[r].fishId] = c,
                            console.log("fishId: " + o[r].fishId)
            ...
            showfishArray3: function(t) {
                ...
                r = 2 * Math.PI,
                c = 4 * Math.PI;
                n = cc.yqs.mathutil.BuildSpiral(s, o, c, 800),
                i = cc.yqs.mathutil.BuildSpiral(s, r, c, 800);
                var a = function() {
                    if (!cc.yqs.gameMgr.frozen && i && !(i.length <= 0)) {
                        ...
                        this.node.addChild(c, 100),
                        c.setPosition(s),
                        c.rotation = o[1].angle;
                        var a = c.getComponent("Fish");
                        a.InitWithTrackPos(o, r),
                        a.setFishId(n.fishId),
                        this.aliveFish[n.fishId] = c
                    }
                };
                this.schedule(function i() {
                    if (!cc.yqs.gameMgr.frozen && n && !(n.length <= 0)) {
                        ...
                        this.node.addChild(h, 100),
                        h.setPosition(s),
                        h.rotation = o[1].angle;
                        var l = h.getComponent("Fish");
                        l.InitWithTrackPos(o, c),
                        l.setFishId(r.fishId),
                        this.aliveFish[r.fishId] = h
                    }
                },
                1, 1e3, 3),
                this.schedule(a, 1, 1e3, 3)
            },
            onChangeScene: function() {
                this.unscheduleAllCallbacks();
            ...
            onCatchFishArray: function(t, e) {
                for (var n = 0; n < t.length; n++) {
                    ...
                    if (s) if (cc.yqs.utils.getOutOfView(s)) this.destroyFish(i);
                    else {
            ...
            showLighting: function(t, e) {
                ...
                if (s) {
                    ...
                    for (var c = 1; c < n.length; c++) {
                        ...
                        a.scaleX = l,
                        a.rotation = h,
                        a.getComponent(cc.Animation).play("bolt"),
                        i.push(a)
                    }
                    this.node.runAction(cc.sequence(cc.delayTime(1), cc.callFunc(function() {
                        for (var t = 0; t < i.length; t++) i[t].getComponent(cc.Animation).stop(),
                        i[t].removeFromParent(),
                        i[t].destroy()
                    })));
    ...
    Fish: [function(t, e, n) {
        ...
        cc.Class({
            ...
            initWithTrackId: function(t, e) {
                this.kind = e,
                this.scoreMulti = cc.yqs.fishMgr.getFishMultiById(this.kind),
                this.isMoveWithAngle = !1,
                this.doMove();
                for (var n = [], i = 0; i < t.length; i++) {
                    s = cc.p(t[i][0], t[i][1]);
                    cc.yqs.mathutil.TransPos(s),
                    n.push(s)
                }
                if (null != n && n.length > 1) if (n.length > 2) this.path = cc.yqs.mathutil.BuildBezier(n, 1e3);
                else {
                    var s = cc.yqs.mathutil.BulidLine(n[0], n[1]);
                    this.node.setPosition(s.pos),
                    this.InitWithAngle(s.angle, e)
                }
            },
            ...
            InitWithTrackPos: function(t, e) {
                ...
                this.isMoveWithAngle = !1,
                this.doMove(),
                null != t && t.length > 1 && (this.path = t)
            },
            doMove: function() {
                this.status = i.swim,
                this.node.getComponent(cc.Animation).play(this.node._name + "move")
            },
            doDie: function() {
                this.status = i.caught,
                this.node.stopAllActions(),
                this.node.color = cc.color(255, 255, 255, 255),
                this.node.getComponent(cc.Animation).play(this.node._name + "die")
            },
            putFishToPool: function() {
                this.node.stopAllActions();
                var t = this.node.getComponent(cc.Animation);
                t && t.stop(),
                cc.yqs.fishMgr.getFishById(this.id) ? cc.yqs.fishMgr.destroyFish(this.id) : this.node.removeFromParent(!0)
            },
            onCatche: function(t) {
                var e = this;
            ...
            getLockedPosByPlayerId: function(t) {
                return null == t && (t = cc.yqs.userMgr.chairId),
                cc.yqs.utils.convertPos(this.lockPos, cc.yqs.roomMgr.getPlayerByIndex(t), cc.p(0, 0))
            },
            onLocked: function() {
                if (!this.locked) {
            ...
            onFrezenScene: function() {
                ...
                this.scheduleOnce(function() {
                    e && e.resume(),
                    1 == t.isMoveWithAngle && t.InitWithAngle(t.node.rotation, t.kind)
                },
            ...
            updatePosition: function(t) {
                if (! (cc.yqs.gameMgr.frozen || 1 == this.isMoveWithAngle || (this.time = this.time + t, this.time < .15 / this.speed || (this.time = 0, this.path.length <= 0 || this.status == i.caught)))) {
                    if (this.index >= this.path.length) return this.node.stopAllActions(),
                    void this.InitWithAngle(this.node.rotation, this.kind);
                    this.node.position = cc.v2(this.path[this.index].pos.x, this.path[this.index].pos.y),
                    this.node.rotation = this.path[this.index].angle,
                    console.log("pos: " + this.index + "(" + this.path[this.index].pos.x + " , " + this.path[this.index].pos.y + ")"),
                    console.log("angle: " + this.path[this.index].angle),
                    this.index++
                }
            },
            onEnable: function() {
    ...
    GameNetMgr: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "a293578d6FJgonO364JAa+U", "GameNetMgr"),
        cc.Class({
            extends: cc.Component,
            properties: {
            ...
            reset: function() {
                this.gamestate = "";
                for (var t = 0; t < this.seats.length; ++t) this.seats[t].ready = !1,
                this.seats[t].userId = 0,
                this.seats[t].score = 0,
                this.seats[t].name = "",
                this.seats[t].seatIndex = t,
                this.seats[t].vip = 0,
                this.seats[t].bullet = 0,
                this.seats[t].power = 0
            },
            clear: function() {
                this.dataEventHandler = null,
                null == this.isOver && (this.seats = null, this.roomId = null, this.maxNumOfGames = 0, this.numOfGames = 0)
            },
            ...
            prepareReplay: function(t, e) {
                this.roomId = t.id,
                this.seats = t.seats,
                this.turn = e.base_info.button;
                for (var n = e.base_info,
                i = 0; i < this.seats.length; ++i) {
                    var s = this.seats[i];
                    s.seatindex = i,
                    s.score = null,
                    s.holds = n.game_seats[i],
                    s.pengs = [],
                    s.angangs = [],
                    s.diangangs = [],
                    s.wangangs = [],
                    s.folds = [],
                    cc.yqs.userMgr.userId == s.userid && (this.seatIndex = i)
                }
                this.conf = {
                    type: n.type
                },
            ...
            initHandlers: function() {
                var t = this;
                cc.yqs.net.addHandler("login_result",
                function(e) {
                    if (cc.log("login_result: " + e), 0 === e.errcode) {
                        var e = e.data;
                        t.roomId = e.roomId,
                        t.conf = e.conf,
                        t.maxNumOfGames = e.conf.maxGames,
                        t.numOfGames = e.numofgames,
                        t.seats = e.seats,
                        t.seatIndex = t.getSeatIndexByID(cc.yqs.userMgr.userId),
                        t.isOver = !1,
                        cc.yqs.userMgr.roomId = e.roomId
                    } else console.log(e.errmsg)
                }),
                cc.yqs.net.addHandler("login_finished",
                function(t) {
                    cc.log("login_finished"),
                    cc.director.loadScene("yqsScene",
                    function() {
                        cc.yqs.net.ping(),
                        cc.yqs.wc.hide()
                    })
                }),
                cc.yqs.net.addHandler("exit_result",
                function(e) {
                    cc.log("exit_result: " + e),
                    t.roomId = null,
                    cc.yqs.userMgr.chairId = -1,
                    t.seats = null
                }),
                cc.yqs.net.addHandler("exit_notify_push",
                function(e) {
                ...
                cc.yqs.net.addHandler("dispress_push",
                function(e) {
                    cc.log("dispress_push: " + e),
                    t.roomId = null,
                    t.turn = -1,
                    t.dingque = -1,
                    t.isDingQueing = !1,
                ...
                cc.yqs.net.addHandler("disconnect",
                function(e) {
                    cc.log("disconnect: " + e),
                    null == t.roomId ? cc.director.loadScene("hall") : 0 == t.isOver ? (cc.yqs.userMgr.oldRoomId = t.roomId, t.dispatchEvent("disconnect")) : t.roomId = null
                }),
                cc.yqs.net.addHandler("new_user_comes_push",
                function(e) {
                    cc.log("new_user_come_push: " + e);
                    var n = e.seatIndex;
                    t.seats[n].userid > 0 ? t.seats[n].online = !0 : (e.online = !0, t.seats[n] = e),
                    cc.yqs.eventCenter.emitCustomEvent("new_user", t.seats[n])
                }),
                cc.yqs.net.addHandler("user_state_push",
                function(e) {
                    cc.log("user_state_push: " + e);
                    var n = e.userid,
                    i = t.getSeatByID(n);
                    i.online = e.online,
                    cc.yqs.eventCenter.emitCustomEvent("user_state_changed", i)
                }),
                cc.yqs.net.addHandler("user_ready_push",
                function(e) {
                ...
                cc.yqs.net.addHandler("game_begin_push",
                function() {
                    cc.log("game_begin_push: " + data),
                    t.dispatchEvent("game_begin"),
                    cc.yqs.eventCenter.dispatchEvent("game_begin")
                }),
                cc.yqs.net.addHandler("game_sync_push",
                function(e) {
                    cc.log("game_sync_push: " + e),
                    t.gamestate = "playing",
                    t.seats = e.seats,
                    cc.yqs.eventCenter.emitCustomEvent("game_sync", e)
                }),
                cc.yqs.net.addHandler("build_fish_reply",
                function(t) {
                    cc.log("build_fish_reply:" + t),
                    cc.yqs.eventCenter.emitCustomEvent("build_fish", t)
                }),
                cc.yqs.net.addHandler("build_fishArray_reply",
                function(t) {
                    cc.log("build_fishArray_reply:" + t),
                    cc.yqs.gameMgr.onChangeScene(),
                    cc.yqs.eventCenter.emitCustomEvent("build_fishArray_reply", t)
                }),
                cc.yqs.net.addHandler("user_fire_Reply",
                function(t) {
                    cc.log("userFireReply: " + t),
                    cc.yqs.eventCenter.emitCustomEvent("room_user_fire", t)
                }),
                cc.yqs.net.addHandler("catch_fish_reply",
                function(t) {
                    cc.log("catchFishReply: " + t),
                    cc.yqs.eventCenter.emitCustomEvent("room_catch_fish", t)
                }),
                cc.yqs.net.addHandler("lock_fish_reply",
                function(t) {
                    cc.log("lockFishReply: " + t),
                    cc.yqs.eventCenter.emitCustomEvent("room_lock_fish", t)
                }),
                cc.yqs.net.addHandler("user_frozen_reply",
                function(t) {
                    cc.log("user_frozen_reply: " + t),
                    cc.yqs.gameMgr.onFrozenScene(t.cutDownTime)
                }),
                cc.yqs.net.addHandler("user_change_cannon_reply",
                function(t) {
                    cc.log("user_change_cannon_reply: " + t),
                    cc.yqs.roomMgr.onChangeCannon(t)
                }),
                cc.yqs.net.addHandler("game_action_push",
                function(e) {
                    cc.log("game_action_push: " + e),
                    t.curaction = e,
                    console.log(e),
                    t.dispatchEvent("game_action", e)
                }),
                cc.yqs.net.addHandler("game_num_push",
                function(e) {
                    cc.log("game_num_push: " + e),
                    t.numOfGames = e,
                    t.dispatchEvent("game_num", e)
                }),
                cc.yqs.net.addHandler("game_over_push",
                function(e) {
                    cc.log("game_over_push: " + e);
                    for (var n = e.results,
                    i = 0; i < t.seats.length; ++i) t.seats[i].score = 0 == n.length ? 0 : n[i].totalscore;
                    t.dispatchEvent("game_over", n),
                    e.endinfo && (t.isOver = !0, t.dispatchEvent("game_end", e.endinfo)),
                    t.reset();
                    for (i = 0; i < t.seats.length; ++i) t.dispatchEvent("user_state_changed", t.seats[i])
                }),
                cc.yqs.net.addHandler("chat_push",
                function(e) {
                    t.dispatchEvent("chat_push", e)
                }),
                cc.yqs.net.addHandler("quick_chat_push",
                function(e) {
                    t.dispatchEvent("quick_chat_push", e)
                }),
                cc.yqs.net.addHandler("emoji_push",
                function(e) {
                    t.dispatchEvent("emoji_push", e)
                }),
                cc.yqs.net.addHandler("voice_msg_push",
                function(e) {
            ...
            connectGameServer: function(t) {
                ...
                cc.yqs.net.ip = t.ip + ":" + t.port,
                console.log(cc.yqs.net.ip);
                cc.yqs.wc.show("正在为你擦桌子"),
                cc.yqs.net.connect(function() {
    ...
    GoldColimnManager: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "d07c8OBWJBK6JNd0XYIgq+6", "GoldColimnManager"),
        cc.Class({
            extends: cc.Component,
            properties: {
                columnArray: {
            ...
            pushScore: function(t, e) {
                if (this.scoreArray.push(t), this.chairId = e, this.scoreArray.length > 10) {
                    for (var n = 0,
                    i = this.scoreArray.length - 1; i > this.scoreArray.length - 6; i--) n += this.scoreArray[i],
                    cc.js.array.removeAt(this.scoreArray, i);
            ...
            updeteGoldPos: function() {
                ...
                var t = 0;
                this.scoreArray.length > 0 && (t = this.scoreArray[0], cc.js.array.removeAt(this.scoreArray, 0)),
                this.showArray.push(t),
                this.drawByShowArray()
            },
            drawByShowArray: function() {
                for (var t = this,
                e = 0; e < this.columnArray.length; e++) {
    ...
    GoldColimn: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "698158lK7hOX7Cr9Gj1jpBT", "GoldColimn"),
        cc.Class({
            extends: cc.Component,
            properties: {
                lblScore: {
            ...
            initWithScore: function(t) {
                ...
                this.node.runAction(cc.sequence(cc.moveBy(.3, cc.p(60 * n, 0)), cc.moveBy(0, cc.p( - 60 * n, 0)), cc.callFunc(function() {
                    ...
                    i.lblScore.string = 0 == t ? "": cc.yqs.utils.transString(t);
    ...
    GonggaoWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "16e8fzGSOxFfLWlYHq86iRh", "GonggaoWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node
    ...
    Hall: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "a518axJx3tGt40UMJHM8Cr0", "Hall"),
        cc.Class({
            extends: cc.Component,
            properties: {
                lblName: cc.Label,
            ...
            onLoad: function() {
                cc.yqs.Hall = this,
                cc.yqs ? (cc.yqs.gameNetMgr.roomId, this.initLeftTopUI(), this.initRightTopUI(), this.initRightBottomUI(), this.initLeftBottomUI(), cc.yqs.userMgr.notice || (cc.yqs.userMgr.notice = {
                    version: null,
                    msg: "数据请求中..."
            ...
            initLeftTopUI: function() {
                this.initLabels(),
                cc.yqs.utils.addClickEvent(this.sprHeadImg.node, this.node, "Hall", "onBtnClicked"),
                this.initButtonHandler("Canvas/top_left/bg_gems/btn_add_gems"),
                this.initButtonHandler("Canvas/top_left/rewardPool"),
                this.initButtonHandler("Canvas/top_left/serverBtn")
            },
            initRightTopUI: function() {
                this.initButtonHandler("Canvas/top_right/btn_shezhi"),
                this.initButtonHandler("Canvas/top_right/btn_quit"),
                this.initButtonHandler("Canvas/top_right/btn_xiaoxi")
            },
            initRightBottomUI: function() {
                this.initButtonHandler("Canvas/bottom_right/quickStart")
            },
            initLeftBottomUI: function() {
                this.initButtonHandler("Canvas/bottom_left/btn_recharge"),
                this.initButtonHandler("Canvas/bottom_left/btn_rank"),
                this.initButtonHandler("Canvas/bottom_left/btn_toMoney"),
                this.initButtonHandler("Canvas/bottom_left/btn_emil"),
                this.initButtonHandler("Canvas/bottom_left/btn_vip"),
                this.initButtonHandler("Canvas/bottom_left/btn_gift"),
                this.initButtonHandler("Canvas/bottom_left/btn_app ")
            },
            refreshInfo: function() {
                ...
                cc.yqs.http.sendRequest("/get_user_status", t,
                function(t) {
            ...
            refreshGemsTip: function() {
                ...
                cc.yqs.http.sendRequest("/get_message", t,
                function(t) {
            ...
            initLabels: function() {
                this.lblName.string = cc.yqs.userMgr.userName,
                this.lblGems.string = cc.yqs.userMgr.gems,
                this.lblID.string = "ID:" + cc.yqs.userMgr.userId
            },
            onBtnClicked: function(t) {
                if ("btn_add_gems" == t.target.name) console.log("addGems clicked"),
                this.rechargeWin.active = !0;
                else if ("rewardPool" == t.target.name) console.log("rewardPool clicked"),
                this.rewardOrderWin.active = !0;
                else if ("serverBtn" == t.target.name) console.log("serverBtn clicked"),
                this.serviceCustomWin.active = !0;
                else if ("btn_shezhi" == t.target.name) console.log("shezhi clicked"),
                this.settingsWin.active = !0;
                else if ("btn_quit" == t.target.name) console.log("quit clicked"),
                cc.director.loadScene("login");
                // else if ("btn_xiaoxi" == t.target.name) return console.log("xiaoxi clicked"),
                // this.xiaoxiWin.active = !0;
                else if ("head" == t.target.name) console.log("head clicked"),
                this.userinfoWin.active = !0,
                this.refreshInfo();
                else if ("quickStart" == t.target.name) console.log("quickStart clicked"),
                this.onJoinGameClicked(null, 1);
                else if ("btn_recharge" == t.target.name) //console.log("btn_recharge clicked"),
                return  cc.yqs.alert.show("", "暂未开放")
                // this.rechargeWin.active = !0;
                else if ("btn_rank" == t.target.name) console.log("btn_rank clicked"),
                this.rankWin.active = !0;
                // else if ("btn_toMoney" == t.target.name) {
                //     console.log("btn_toMoney clicked");
                //     var e = cc.find("Canvas/bangdingshouji"),
                //     n = cc.scaleTo(.2, 1.2),
                //     i = cc.scaleTo(.1, 1);
                //     cc.yqs.alert.show("", "您的账号尚未绑定手机,请先绑定后，在进行的兑换操作",
                //     function() {
            ...
            onJoinGameClicked: function(t, e) {
                ...
                switch (e) {
                case "1":
                    if (cc.yqs.userMgr.gems < .1) return void cc.yqs.alert.show("", "余额不足",
                    function() {});
                    break;
                case "2":
                    if (cc.yqs.userMgr.gems < 10) return void cc.yqs.alert.show("", "余额不足",
                    function() {});
                    break;
                case "3":
                    if (cc.yqs.userMgr.gems < 100) return void cc.yqs.alert.show("", "余额不足",
                    function() {});
                    break;
                case "4":
                    if (cc.yqs.userMgr.gems < 1e3) return void cc.yqs.alert.show("", "余额不足",
                    function() {});
                    break;
                case "5":
                case "6":
            ...
            EnterGame: function(t) {
                ...
                cc.yqs.userMgr.enterPublicRoom(e.toString(),
                function(t) {
                    0 == t.errcode ? cc.yqs.gameNetMgr.connectGameServer(t) : cc.vv.alert.show("提示", "进入房间失败")
                }.bind(this))
            },
            update: function(t) {
                var e = this.lblNotice.node.x; (e -= 100 * t) + this.lblNotice.node.width < -1e3 && (e = 500),
                this.lblNotice.node.x = e,
                cc.yqs && null != cc.yqs.userMgr.roomData && (cc.yqs.userMgr.enterRoom(cc.yqs.userMgr.roomData), console.log("++++++++++" + cc.yqs.userMgr.roomData), cc.yqs.userMgr.roomData = null)
            }
        }),
        cc._RF.pop()
    },
    ...
    HeadIcon: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "e534cnF181OArI6DN5cKbxJ", "HeadIcon"),
        cc.Class({
            extends: cc.Component,
            properties: {
                avatarFrame: {
            ...
            onLoad: function() {
                ...
                t || (t = 1),
                t <= this.avatarFrame.length && (this.node.spriteFrame = this.avatarFrame[t - 1])
            },
            onEnable: function() {
    ...
    HelpWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "f4df0c3NLdKKKJlcjs5bLrR", "HelpWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node,
    ...
    HotUpdate: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "c326b+yAjZGZblBqC9UjI+A", "HotUpdate"),
        cc.Class({
            extends: cc.Component,
            properties: {
                updatePanel: {
            ...
            updateCb: function(t) {
                ...
                case jsb.EventAssetsManager.UPDATE_FAILED:
                    ...
                    ++this._failCount < 5 ? this._am.downloadFailedAssets() : (cc.log("Reach maximum fail count, exit update process"), this._failCount = 0, n = !0);
                    break;
            ...
            onLoad: function() {
                if (cc.sys.isNative) {
                    ...
                    cc.log("Storage path for remote asset : " + t),
                    this.lblErr.string += t + "\n",
                    cc.log("Local manifest URL : " + this.manifestUrl),
                    this._am = new jsb.AssetsManager(this.manifestUrl, t),
                    this._am.retain(),
                    this._needUpdate = !1,
                    this._am.getLocalManifest().isLoaded() && (this._checkListener = new jsb.EventListenerAssetsManager(this._am, this.checkCb.bind(this)), cc.eventManager.addListener(this._checkListener, 1), this._am.checkUpdate())
                }
            },
            onDestroy: function() {
    ...
    ItemInfoWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "30163aKrvBEYq7Cyy5v1Kvm", "ItemInfoWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node,
            ...
            onLoad: function() {
                ...
                t || (t = cc.yqs.userMgr.item.ice),
                this.hasNum.string = t
            },
            onEnable: function() {
                this.commonBg.scale = .2;
                var t = cc.scaleTo(.2, 1.2),
        ...
        e.exports = {
            init: function(t) {
                if (!t || t !== window.i18n.curLang) {
                    var e = null;
                    t ? (e = i(t), window.i18n.curLang = t) : e = i(window.i18n.curLang),
                    s(e)
                }
            },
            t: function(t, e) {
    ...
    Laser: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "da8b5Z6L5hL/ZyhWjPN1CQg", "Laser"),
        cc.Class({
            extends: cc.Component,
            properties: {},
            onLoad: function() {
            ...
            startCollider: function() {
                console.log("laser:: " + this.catchedFish.length),
                cc.yqs.gameMgr.send_laser_catch_fish(cc.yqs.userMgr.userId, cc.yqs.userMgr.chairId, this.catchedFish)
            },
            onCollisionEnter: function(t, e) {
    ...
    Loading: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "0ef08mGSGBFxKM/jy0rZMcS", "Loading"),
        cc.Class({
            extends: cc.Component,
            properties: {
                progress: {
            ...
            onLoad: function() {
                ...
                this.splash.active = !0,
                this.loadingBg = cc.find("Canvas/loadingBg"),
                this.loadingBg.active = !1,
                this.loadFinish = !1
            },
            loadRes: function() {
                var t = this;
                cc.loader.loadResDir("yqs",
                function(e, n, i) {
                    t.lblProgress.string = "( " + parseFloat(e / n * 100).toFixed(0) + "% )",
                    t.progress.progress = e / n
                },
                function(e, n) {
                    t.onLoadComplete()
                })
            ...
            start: function() {
                var t = this;
                if (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative) this.splash.active = !1,
                t.loadingBg.active = !0;
                else {
                    t.splash.active = !0;
                    var e = Date.now(); !
                    function n() {
                        var i = Date.now() - e;
                        if (i < 1) setTimeout(n, 33),
                        t.lblTemp && (t.lblTemp.string = parseFloat(100 * i / 1).toFixed(0) + "%");
                        else {
                            var s = 255 * (1 - (i - 1) / 500);
            ...
            checkVersion: function() {
                ...
                i = !1,
                s = function() {
                    n = cc.yqs.http.sendRequest("/get_serverinfo", null,
                    function(t) {
                        n = null,
                        i = !0,
                        e(t)
            ...
            onLoadComplete: function() {
                this.loadFinish = !0,
                this.splash.active && this.splash.opacity > 0 ? this.scheduleOnce(function() {
                    cc.director.loadScene("login")
                },
            ...
            initMgr: function() {
                cc.yqs = {},
                cc.yqs.http = t("HTTP"),
                cc.yqs.global = t("Global"),
                cc.yqs.net = t("Net"),
                cc.yqs.eventCenter = t("EventCenter");
                var e = t("GameNetMgr");
                cc.yqs.gameNetMgr = new e,
                cc.yqs.gameNetMgr.initHandlers();
                var n = t("UserMgr");
                cc.yqs.userMgr = new n;
                var i = t("AudioMgr");
                cc.yqs.audioMgr = new i,
                cc.yqs.audioMgr.init();
                var s = t("Utils");
                cc.yqs.utils = new s;
                var o = t("MathUtil");
                cc.yqs.mathutil = new o,
                cc.args = this.urlParse()
            },
            initLanguage: function() {
                cc.yqs.Language = t("LanguageData"),
                cc.yqs.Language.init("zh"),
                cc.yqs.getString = cc.yqs.Language.t,
                console.log(cc.yqs.getString("hello"))
            },
            urlParse: function() {
                var t = {};
                if (null == window.location) return t;
                for (var e, n, i = window.location.href,
                s = i.indexOf("?"), o = (i = i.substr(s + 1)).split("&"), r = 0; r < o.length; r++)(s = o[r].indexOf("=")) > 0 && (e = o[r].substring(0, s), n = o[r].substr(s + 1), t[e] = n);
                return t
            }
        }),
        cc._RF.pop()
    ...
    LocalizedSprite: [function(t, e, n) {
        ...
        cc.Class({
            ...
            updateSprite: function(t) {
                if (this.sprite) {
                    var e = this.getSpriteFrameByLang(t); ! e && this.spriteFrameSet[0] && (e = this.spriteFrameSet[0].spriteFrame),
    ...
    Login: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "a0912fUK6dDmJBCTPrzvtHO", "Login"),
        cc.Class({
            extends: cc.Component,
            properties: {
                _mima: null,
    ...
    MathUtil: [function(t, e, n) {
        ...
        function i(t, e) {
            for (var n = function(t, e) {
                var n = new cc.p(0, 0);
                return 3 == t.length ? (n.x = Math.pow(1 - e, 2) * t[0].x + 2 * (1 - e) * e * t[1].x + e * e * t[2].x, n.y = Math.pow(1 - e, 2) * t[0].y + 2 * (1 - e) * e * t[1].y + e * e * t[2].y) : 4 == t.length ? (n.x = Math.pow(1 - e, 3) * t[0].x + 3 * Math.pow(1 - e, 2) * e * t[1].x + 3 * (1 - e) * e * e * t[2].x + e * e * e * t[3].x, n.y = Math.pow(1 - e, 3) * t[0].y + 3 * Math.pow(1 - e, 2) * e * t[1].y + 3 * (1 - e) * e * e * t[2].y + e * e * e * t[3].y) : console.log("点数出错:: count == " + t.length),
                n
            },
            i = [], s = 1 / e, o = 0; o < e; o++) {
                var r = new c;
                r.pos = n(t, s),
                r.angle = 0 == o ? -1 * cc.yqs.mathutil.getAngleByPos(r.pos, n(t, o * s)) : -1 * cc.yqs.mathutil.getAngleByPos(i[o - 1].pos, r.pos),
                i[o] = r,
                s += 1 / e
            }
            return r.pos = cc.p(t[t.length - 1].x, t[t.length - 1].y),
            r.angle = cc.yqs.mathutil.getAngleByPos(i[i.length - 1].pos, r.pos),
            i[i.length] = r,
            i
        }
        function s(t, e, n) {
            for (var i = [], s = 2 * Math.PI / n, o = 0; o < n; o++) {
                ...
                l = e * Math.sin(a) + t.y;
                r.pos = cc.p(h, l),
                r.angle = cc.yqs.mathutil.redian2angle(a),
                i[o] = r
            }
            return i
        }
        function o(t, e) {
            var n = new c;
            return n.pos = cc.p(t.x, t.y),
            n.angle = -1 * cc.yqs.mathutil.getAngleByPos(n.pos, cc.p(e.x, e.y)),
            n
        }
        function r(t, e, n, i) {
            for (var s = [], o = 10, r = n / i, a = 0; a < i; a++) {
                ...
                f = o * Math.sin(l) + t.y;
                h.pos = cc.p(u, f),
                h.angle = 0 == a ? -1 * cc.yqs.mathutil.redian2angle(.5 * Math.PI) : -1 * cc.yqs.mathutil.getAngleByPos(s[a - 1].pos, h.pos),
                s[a] = h
            }
            return s
        }
        ...
        cc.Class({
            ...
            TransPos: function(t) {
                t.x = 1280 * (t.x - 640) / 1366,
                t.y = 720 * (t.y - 360) / 768,
                cc.yqs.mathutil.needViewTrans() && (t.x = -1 * t.x, t.y = -1 * t.y)
            },
            ...
            getAngleByPos: function(t, e) {
                ...
                return e.y >= t.y && (s = cc.yqs.mathutil.redian2angle(Math.acos(i))),
                s
            },
            ...
            statics: {
                ...
                addHandler: function(t, e) {
                    if (this.handlers[t]) console.log("event:" + t + "' handler has been registered.");
                        ...
                        var n = function(n) {
                            "disconnect" != t && "string" == typeof n && (n = JSON.parse(n)),
                            e(n)
                        };
                        this.handlers[t] = n,
                        this.sio && (console.log("register:function " + t), this.sio.on(t, n))
                    }
                },
                connect: function(t, e) {
                    ...
                    this.sio = window.io.connect(this.ip, i),
                    this.sio.on("connect",
                    function(e) {
                        n.sio.connected = !0,
                        t(e)
                    ...
                    function(t) {
                        ...
                        n.sio.connected = !1,
                        n.close(),
                        "yqsScene" == cc.director.getScene().name && cc.yqs.roomMgr.onExitClick()
                    }),
                ...
                startHearbeat: function() {
                    ...
                    var t = this;
                    console.log(1),
                    t.isPinging || (console.log(1), t.isPinging = !0, setInterval(function() {
                ...
                close: function() {
                    console.log("close"),
                    this.delayMS = null,
                    this.sio && this.sio.connected && (this.sio.connected = !1, this.sio.disconnect(), this.sio = null),
                ...
                test: function(t) {
                    ...
                    e = cc.yqs.http.sendRequest("/is_server_online", i,
                    function(n) {
                        t(n.isonline),
                        e = null
                    }),
    ...
    NodePoolManager: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "1dd55yoqsVIcY8nvgwNaRd1", "NodePoolManager"),
        cc.Class({
            extends: cc.Component,
            properties: {
                fishPrefabs: {
    ...
    NoticeTip: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "76ca6bNRtlIX4u8b0Womsgc", "NoticeTip"),
        cc.Class({
            extends: cc.Component,
            properties: {
                _guohu: null,
    ...
    OnBack: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "8d166QjcqxGm7rnRW3BVAAQ", "OnBack"),
        cc.Class({
            extends: cc.Component,
            properties: {},
            onLoad: function() {
    ...
    PrivilegeWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "65ea7NHXLtGKbOTSwvyVvTG", "PrivilegeWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node,
            ...
            onLoad: function() {
                ...
                this.curPageIndex = cc.yqs.userMgr.vip,
                this.money = cc.yqs.userMgr.money,
                this.gunIndex = this.curPageIndex,
                console.log(this.money + "币"),
                this.beforeBtn.node.active = this.curPageIndex > 0,
                this.afterBtn.node.active = this.curPageIndex < Object.getOwnPropertyNames(this.benfitConfig).length - 1,
                this.pageView.setCurrentPageIndex(this.curPageIndex),
                6 == this.curPageIndex ? (this.tipString = "您已达最高级！", this.lblTip.string = this.tipString, this.leftLabel.string = this.curPageIndex, this.rightLabel.string = this.curPageIndex) : (this.remoney = this.benfitConfig[this.curPageIndex + 1] - this.money, this.tipString = "在充值%s币即可升级到vip%s", this.lblTip.string = cc.js.formatStr(this.tipString, this.remoney.toFixed(2), this.curPageIndex + 1), this.leftLabel.string = this.curPageIndex, this.rightLabel.string = this.curPageIndex + 1),
                this.vipprogress.progress = this.money / this.benfitConfig[this.curPageIndex + 1]
            },
            onEnable: function() {
                this.commonBg.scale = .2;
                var t = cc.scaleTo(.2, 1.2),
            ...
            onBack: function() {
                ...
                i = cc.callFunc(function() {
                    t.pageView.scrollToPage(this.curPageIndex),
                    this.pageView.setCurrentPageIndex(this.curPageIndex),
                    t.node.active = !1
                },
                this);
    ...
    RankWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "f1c8cGVq/tKgplous6helVs", "RankWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node
    ...
    ReConnect: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "dcf2dPxANFMRalCS1I3tnlt", "ReConnect"),
        cc.Class({
            extends: cc.Component,
            properties: {
                _reconnect: null,
            ...
            onLoad: function() {
                ...
                function n(i) {
                    t.node.off("disconnect", n),
                    t._reconnect.active = !0,
                    e()
                })
            },
            update: function(t) {
    ...
    RechargeWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "0c2d13/EzlC3JRtWgC5f14U", "RechargeWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: {
            ...
            onLoad: function() {
                this.rechargeType = 1,
                this.rechargeAccount.string = cc.yqs.userMgr.account
            },
            onEnable: function() {
                this.commonBg.scale = .2;
                var t = cc.scaleTo(.2, 1.2),
            ...
            onRadioBtnClick: function(t, e) {
                this.rechargeType = e,
                1 == e ? (this.aliPanel.active = !0, this.otherPanel.active = !1, this.rechargeTip.string = cc.yqs.getString("key12")) : 2 == e ? (this.aliPanel.active = !0, this.otherPanel.active = !1, this.rechargeTip.string = cc.yqs.getString("key13")) : 3 == e && (this.aliPanel.active = !1, this.otherPanel.active = !0)
            },
            onRechargeBtnClick: function(t, e) {
                console.log(e),
                this.numberRechargeBox.string = e
            },
            onConfimClick: function() {
                var t = this;
                t.numberRechargeBox.string ? cc.yqs.alert.show("", "充值接口未开放",
                function() {
                    console.log("recharge num: " + parseFloat(t.numberRechargeBox.string).toFixed(2) + " by: " + t.rechargeType),
                    t.node.active = !1
                },
    ...
    RewardFish: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "814f4oz2JhGoqpDz23CCL7x", "RewardFish"),
        cc.Class({
            extends: cc.Component,
            properties: {
                fishHead: {
            ...
            playReward: function(t, e) {
                ...
                this.fishHead.spriteFrame = n[t] || null,
                this.gold.string = cc.yqs.utils.transString(e)
            }
        }),
        cc._RF.pop()
    },
    ...
    RewardOrderWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "d2ae7ySrtpEXZ8cv/QyIV+b", "RewardOrderWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node
    ...
    RoomMgr: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "88495SoqZJKX6a5qY/jeUBv", "RoomMgr"),
        cc.Class({
            extends: cc.Component,
            properties: {
                Seats: {
            ...
            initView: function(t) {
                ...
                this.transViewSeat(),
                this.lblRoomNo.string = "渔场ID: " + cc.yqs.userMgr.roomId,
                this.isGlobalPlaying = !1,
                this.globalMsgList = [],
                this.globalMsgList.push(1),
                this.globalMsgList.push(2),
                this.globalMsgList.push(3)
            },
            transViewSeat: function() {
                if (cc.yqs.mathutil.needViewTrans()) {
                    var t = this.Seats[0];
                    this.Seats[0] = this.Seats[2],
                    this.Seats[2] = t;
                    var e = this.Seats[1];
                    this.Seats[1] = this.Seats[3],
                    this.Seats[3] = e
                }
                for (var n = 0; n < this.Seats.length; n++) {
                    ...
                    if (i) {
                        var s = i.chairId;
                        s = cc.yqs.mathutil.logicToViewSeat(s),
                        i.chairId = s
                    }
                }
            },
            onEnable: function() {
                cc.yqs.eventCenter.addEvent(this, "game_sync", this.game_sync),
                cc.yqs.eventCenter.addEvent(this, "new_user", this.new_user),
                cc.yqs.eventCenter.addEvent(this, "user_state_changed", this.user_state_changed),
                cc.yqs.eventCenter.addEvent(this, "room_user_fire", this.fireWithData),
                cc.yqs.eventCenter.addEvent(this, "room_catch_fish", this.catchFishWithData),
                cc.yqs.eventCenter.addEvent(this, "room_lock_fish", this.lockFishWithData),
                this.node.on(cc.Node.EventType.TOUCH_START, this.onTouchBegin, this),
                this.node.on(cc.Node.EventType.TOUCH_MOVE, this.onTouchMove, this)
            },
            onDisable: function() {
                cc.yqs.eventCenter.removeEvent(this, "game_sync", this.game_sync),
                cc.yqs.eventCenter.removeEvent(this, "new_user", this.new_user),
                cc.yqs.eventCenter.removeEvent(this, "user_state_changed", this.user_state_changed),
                cc.yqs.eventCenter.removeEvent(this, "room_user_fire", this.fireWithData),
                cc.yqs.eventCenter.removeEvent(this, "room_catch_fish", this.catchFishWithData),
                cc.yqs.eventCenter.removeEvent(this, "room_lock_fish", this.lockFishWithData),
            ...
            game_sync: function(t) {
                ...
                cc.yqs.gameMgr.sceneMulti = Math.floor(t.detail.roomBaseScore) / 1e3,
                this.initView(t.detail.seats),
                this.initSeats(t.detail.seats)
            },
            new_user: function(t) {
            ...
            onExitClick: function() {
                ...
                cc.yqs.gameMgr.onStop(),
                cc.yqs.fishMgr.onStop(),
                cc.yqs.bulletMgr.onStop(),
                cc.yqs.net.send("exit"),
            ...
            showGlobal: function() {
                if (! (this.isGlobalPlaying || this.globalMsgList.length < 1)) {
                    ...
                    i = cc.callFunc(function() {
                        t.globalText.node.position = cc.p(640, 0),
                        this.isGlobalPlaying = !1,
                        t.showGlobal()
                    },
                    this);
                    this.globalText.node.runAction(cc.sequence(n, i)),
                    cc.js.array.removeAt(this.globalMsgList, 0)
                }
            },
            update: function(t) {
    ...
    ServiceCustomWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "b71f4HcbcFDKa1zAjGz9IIh", "ServiceCustomWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node
    ...
    SettingWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "9030dwF59NNmIyZN2gApAHS", "SettingWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node,
            ...
            onLoad: function() {
                if (null != cc.yqs) {
                    this._btnYXOpen = cc.find("commonBg/psBg/yinxiao/btn_yx_open", this.node),
                    this._btnYXClose = cc.find("commonBg/psBg/yinxiao/btn_yx_close", this.node),
                    this._btnYYOpen = cc.find("commonBg/psBg/yinyue/btn_yy_open", this.node),
                    this._btnYYClose = cc.find("commonBg/psBg/yinyue/btn_yy_close", this.node),
            ...
            onSlided: function(t) {
                "yinxiao" == t.node.parent.name ? cc.yqs.audioMgr.setSFXVolume(t.progress) : "yinyue" == t.node.parent.name && cc.yqs.audioMgr.setBGMVolume(t.progress),
                this.refreshVolume()
            },
            initButtonHandler: function(t) {
            ...
            refreshVolume: function() {
                this._btnYXClose.active = cc.yqs.audioMgr.sfxVolume > 0,
                this._btnYXOpen.active = !this._btnYXClose.active,
                (e = cc.find("commonBg/psBg/yinxiao/progress", this.node)).getComponent(cc.Slider).progress = cc.yqs.audioMgr.sfxVolume;
                var t = 430 * cc.yqs.audioMgr.sfxVolume;
                e.getChildByName("progress") && (e.getChildByName("progress").width = t),
                this._btnYYClose.active = cc.yqs.audioMgr.bgmVolume > 0,
                this._btnYYOpen.active = !this._btnYYClose.active;
                var e = cc.find("commonBg/psBg/yinyue/progress", this.node),
                n = 430 * cc.yqs.audioMgr.bgmVolume;
                e.getComponent(cc.Slider).progress = cc.yqs.audioMgr.bgmVolume,
                e.getChildByName("progress").width = n
            },
            onBtnClicked: function(t) {
    ...
    {}],
    TimelineLite: [function(t, e, n) { (function(n) {
            "use strict";
            ...
            var i = void 0 !== e && e.exports && void 0 !== n ? n: window; (i._gsQueue || (i._gsQueue = [])).push(function() {
                ...
                function(t, e, n) {
                    var s = function(t) {
                        ...
                        var n, i, s = this.vars;
                        for (i in s) n = s[i],
                        a(n) && -1 !== n.join("").indexOf("{self}") && (s[i] = this._swapSelfInParams(n));
                    ...
                    d = function(t, e, n) {
                        var i, s, o = t.cycle;
                        for (i in o) s = o[i],
                        t[i] = "function" == typeof s ? s(n, e[n]) : s[n % s.length];
                        delete t.cycle
                    },
                    ...
                    m.staggerTo = function(t, e, i, o, r, a, h, l) {
                        ...
                        y = i.cycle;
                        for ("string" == typeof t && (t = n.selector(t) || t), c(t = t || []) && (t = g(t)), (o = o || 0) < 0 && ((t = g(t)).reverse(), o *= -1), p = 0; p < t.length; p++)(u = f(i)).startAt && (u.startAt = f(u.startAt), u.startAt.cycle && d(u.startAt, t, p)),
                        y && (d(u, t, p), null != u.duration && (e = u.duration, delete u.duration)),
                        m.to(t[p], e, u, p * o);
                        return this.add(m, r)
                    },
                    ...
                    s.exportRoot = function(t, e) {
                        ...
                        var i, o, r = new s(t),
                        c = r._timeline;
                        for (null == e && (e = !0), c._remove(r, !0), r._startTime = 0, r._rawPrevTime = r._time = r._totalTime = c._time, i = c._first; i;) o = i._next,
                        e && i instanceof n && i.target === i.vars.onComplete || r.add(i, i._startTime - i._delay),
                        i = o;
                        return c.add(r, 0),
                        r
                    },
                    m.add = function(i, o, r, c) {
                        ...
                        if ("number" != typeof o && (o = this._parseTimeOrLabel(o, 0, !0, i)), !(i instanceof t)) {
                            if (i instanceof Array || i && i.push && a(i)) {
                                ...
                                this.add(f, h),
                                "string" != typeof f && "function" != typeof f && ("sequence" === r ? h = f._startTime + f.totalDuration() / f._timeScale: "start" === r && (f._startTime -= f.delay())),
                                h += c;
                        ...
                        if (e.prototype.add.call(this, i, o), (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration()) for (p = (d = this).rawTime() > i._startTime; d._timeline;) p && d._timeline.smoothChildTiming ? d.totalTime(d._totalTime, !0) : d._gc && d._enabled(!0, !1),
                        d = d._timeline;
                        return this
                    },
                    m.remove = function(e) {
                    ...
                    m._parseTimeOrLabel = function(e, n, i, s) {
                        ...
                        else if (s && (s instanceof Array || s.push && a(s))) for (o = s.length; --o > -1;) s[o] instanceof t && s[o].timeline === this && this.remove(s[o]);
                    ...
                    m.render = function(t, e, n) {
                        ...
                        g = this._timeScale,
                        m = this._paused;
                        if (t >= f - 1e-7 && t >= 0) this._totalTime = this._time = f,
                        this._reversed || this._hasPausedChild() || (s = !0, r = "onComplete", c = !!this._timeline.autoRemoveChildren, 0 === this._duration && (t <= 0 && t >= -1e-7 || this._rawPrevTime < 0 || 1e-10 === this._rawPrevTime) && this._rawPrevTime !== t && this._first && (c = !0, this._rawPrevTime > 1e-10 && (r = "onReverseComplete"))),
                        this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t: 1e-10,
                        t = f + 1e-4;
                        else if (t < 1e-7) if (this._totalTime = this._time = 0, (0 !== d || 0 === this._duration && 1e-10 !== this._rawPrevTime && (this._rawPrevTime > 0 || t < 0 && this._rawPrevTime >= 0)) && (r = "onReverseComplete", s = this._reversed), t < 0) this._active = !1,
                        this._timeline.autoRemoveChildren && this._reversed ? (c = s = !0, r = "onReverseComplete") : this._rawPrevTime >= 0 && this._first && (c = !0),
                        this._rawPrevTime = t;
                        else {
                            if (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t: 1e-10, 0 === t && s) for (i = this._first; i && 0 === i._startTime;) i._duration || (s = !1),
                            i = i._next;
                            t = 0,
                            this._initted || (c = !0)
                        } else {
                            if (this._hasPause && !this._forcingPlayhead && !e) {
                                if (t >= d) for (i = this._first; i && i._startTime <= t && !a;) i._duration || "isPause" !== i.data || i.ratio || 0 === i._startTime && 0 === this._rawPrevTime || (a = i),
                                i = i._next;
                                else for (i = this._last; i && i._startTime >= t && !a;) i._duration || "isPause" === i.data && i._rawPrevTime > 0 && (a = i),
                                i = i._prev;
                        ...
                        if (this._time !== d && this._first || n || c || a) {
                            ...
                            i = o;
                            else for (i = this._last; i && (o = i._prev, u === this._time && (!this._paused || m));) {
                                if (i._active || i._startTime <= d && !i._paused && !i._gc) {
                                    if (a === i) {
                                        for (a = i._prev; a && a.endTime() > this._time;) a.render(a._reversed ? a.totalDuration() - (t - a._startTime) * a._timeScale: (t - a._startTime) * a._timeScale, e, n),
                                        a = a._prev;
                                        a = null,
                                        this.pause()
                                    }
                            ...
                            this._onUpdate && (e || (h.length && l(), this._callback("onUpdate"))),
                            r && (this._gc || p !== this._startTime && g === this._timeScale || (0 === this._time || f >= this.totalDuration()) && (s && (h.length && l(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[r] && this._callback(r)))
                        }
                    },
                    ...
                    m.getChildren = function(t, e, i, s) {
                        s = s || -9999999999;
                        for (var o = [], r = this._first, c = 0; r;) r._startTime < s || (r instanceof n ? !1 !== e && (o[c++] = r) : (!1 !== i && (o[c++] = r), !1 !== t && (c = (o = o.concat(r.getChildren(!0, e, i))).length))),
                        r = r._next;
                        return o
                    },
                    ...
                    m.shiftChildren = function(t, e, n) {
                        n = n || 0;
                        for (var i, s = this._first,
                        o = this._labels; s;) s._startTime >= n && (s._startTime += t),
                        s = s._next;
                    ...
                    m.totalDuration = function(t) {
                        if (!arguments.length) {
                            if (this._dirty) {
                                ...
                                s._startTime < 0 && !s._paused && (i -= s._startTime, this._timeline.smoothChildTiming && (this._startTime += s._startTime / this._timeScale), this.shiftChildren( - s._startTime, !1, -9999999999), o = 0),
    ...
    TweenLite: [function(t, e, n) { (function(t) {
            "use strict";
                ...
                if (!r.TweenLite) {
                    ...
                    v = function n(i, o, c, a) {
                        ...
                        this.check = function(l) {
                            for (var u, d, p, g, m, v = o.length,
                            _ = v; --v > -1;)(u = y[o[v]] || new n(o[v], [])).gsClass ? (h[v] = u.gsClass, _--) : l && u.sc.push(this);
                            if (0 === _ && c) {
                                if (d = ("com.greensock." + i).split("."), p = d.pop(), g = f(d.join("."))[p] = this.gsClass = c.apply(c, h), a) if (r[p] = s[p] = g, !(m = void 0 !== e && e.exports) && "function" == typeof define && define.amd) define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/": "") + i.split(".").pop(), [],
                                function() {
                                    return g
                                });
                    ...
                    T = w.register = function(t, e, n, i) {
                        for (var s, o, r, c, a = e.split(","), h = a.length, l = (n || "easeIn,easeOut,easeInOut").split(","); --h > -1;) for (o = a[h], s = i ? b("easing." + o, null, !0) : d.easing[o] || {},
                        r = l.length; --r > -1;) c = l[r],
                        k[o + "." + c] = k[c + o] = s[c] = t.getRatio ? t: t[c] || new t
                    };
                    ...
                    a = (c = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; --a > -1;) h = c[a] + ",Power" + a,
                    T(new w(null, null, 1, a), h, "easeOut", !0),
                    T(new w(null, null, 2, a), h, "easeIn" + (0 === a ? ",easeNone": "")),
                    T(new w(null, null, 3, a), h, "easeInOut");
                    k.linear = d.easing.Linear.easeIn,
                    k.swing = d.easing.Quad.easeInOut;
                    var A = b("events.EventDispatcher",
                    function(t) {
                        this._listeners = {},
                    ...
                    S = P();
                    for (a = (c = ["ms", "moz", "webkit", "o"]).length; --a > -1 && !q;) q = t[c[a] + "RequestAnimationFrame"],
                    B = t[c[a] + "CancelAnimationFrame"] || t[c[a] + "CancelRequestAnimationFrame"];
                    b("Ticker",
                    function(t, e) {
                        ...
                        m = function t(e) {
                            ...
                            a.time = (S - h) / 1e3,
                            o = a.time - c,
                            (!n || o > 0 || !0 === e) && (a.frame++, c += o + (o >= r ? .004 : r - o), l = !0),
                            !0 !== e && (s = i(t)),
                        ...
                        a.wake = function(t) {
                            null !== s ? a.sleep() : t ? h += -S + (S = P()) : a.frame > 10 && (S = P() - d + 5),
                            i = 0 === n ? g: f && q ? q: function(t) {
                    ...
                    var x = b("core.Animation",
                    function(t, e) {
                        if (this.vars = e = e || {},
                        this._duration = this._totalDuration = t || 0, this._delay = Number(e.delay) || 0, this._timeScale = 1, this._active = !0 === e.immediateRender, this.data = e.data, this._reversed = !0 === e.reversed, V) {
                            u || l.wake();
                    ...
                    l = x.ticker = new d.Ticker,
                    (h = x.prototype)._dirty = h._gc = h._initted = h._paused = !1,
                    ...
                    h.eventCallback = function(t, e, n, i) {
                        if ("on" === (t || "").substr(0, 2)) {
                            ...
                            null == e ? delete s[t] : (s[t] = e, s[t + "Params"] = m(n) && -1 !== n.join("").indexOf("{self}") ? this._swapSelfInParams(n) : n, s[t + "Scope"] = i),
                    ...
                    h.totalTime = function(t, e, n) {
                        ...
                        if (this._timeline) {
                            if (t < 0 && !n && (t += this.totalDuration()), this._timeline.smoothChildTiming) {
                                ...
                                s = this._timeline;
                                if (t > i && !n && (t = i), this._startTime = (this._paused ? this._pauseTime: s._time) - (this._reversed ? i - t: t) / this._timeScale, s._dirty || this._uncache(!1), s._timeline) for (; s._timeline;) s._timeline._time !== (s._startTime + s._totalTime) / s._timeScale && s.totalTime(s._totalTime, !0),
                                s = s._timeline
                            }
                            this._gc && this._enabled(!0, !1),
                            this._totalTime === t && 0 !== this._duration || (E.length && X(), this.render(t, e, !1), E.length && X())
                        }
                        return this
                    },
                    ...
                    h.paused = function(t) {
                        ...
                        return t != this._paused && i && (u || t || l.wake(), n = (e = i.rawTime()) - this._pauseTime, !t && i.smoothChildTiming && (this._startTime += n, this._uncache(!1)), this._pauseTime = t ? e: null, this._paused = t, this._active = this.isActive(), !t && 0 !== n && this._initted && this.duration() && (e = i.smoothChildTiming ? this._totalTime: (e - this._startTime) / this._timeScale, this.render(e, e === this._totalTime, !0))),
                        this._gc && !t && this._enabled(!0, !1),
                        this
                    };
                    var I = b("core.SimpleTimeline",
                    function(t) {
                        x.call(this, 0, t),
                        this.autoRemoveChildren = this.smoothChildTiming = !0
                    }); (h = I.prototype = new x).constructor = I,
                    h.kill()._gc = !1,
                    h._first = h._last = h._recent = null,
                    h._sortChildren = !1,
                    h.add = h.insert = function(t, e, n, i) {
                        var s, o;
                    ...
                    h.render = function(t, e, n) {
                        var i, s = this._first;
                        for (this._totalTime = this._time = this._rawPrevTime = t; s;) i = s._next,
                        (s._active || t >= s._startTime && !s._paused) && (s._reversed ? s.render((s._dirty ? s.totalDuration() : s._totalDuration) - (t - s._startTime) * s._timeScale, e, n) : s.render((t - s._startTime) * s._timeScale, e, n)),
                        s = i
                    },
                    h.rawTime = function() {
                        return u || l.wake(),
                    ...
                    function(e, n, i) {
                        ...
                        1 === a && this._siblings.length > 1 && $(e, this, null, 1, this._siblings); (this.vars.immediateRender || 0 === n && 0 === this._delay && !1 !== this.vars.immediateRender) && (this._time = -1e-10, this.render(Math.min(0, -this._delay)))
                    },
                    !0),
                    F = function(e) {
                    ...
                    R = function(t, e) {
                        ...
                        t.css = i
                    }; (h = M.prototype = new x).constructor = M,
                    h.kill()._gc = !1,
                    h.ratio = 0,
                    h._firstPT = h._targets = h._overwrittenProps = h._startAt = null,
                    h._notifyPluginsOfEnabled = h._lazy = !1,
                    M.version = "1.19.1",
                    M.defaultEase = h._ease = new w(null, null, 1, 1),
                    ...
                    D = function(t, e, n, i) {
                        ...
                        d = "",
                        p = 0;
                        for (u.start = t, u.end = e, t = u[0] = t + "", e = u[1] = e + "", n && (n(u), t = u[0], e = u[1]), u.length = 0, s = t.match(N) || [], o = e.match(N) || [], i && (i._next = null, i.blob = 1, u._firstPT = u._applyPT = i), a = o.length, c = 0; c < a; c++) l = o[c],
                        d += (h = e.substr(f, e.indexOf(l, f) - f)) || !c ? h: ",",
                        f += h.length,
                        p ? p = (p + 1) % 5 : "rgba(" === h.substr( - 5) && (p = 1),
                        l === s[c] || s.length <= c ? d += l: (d && (u.push(d), d = ""), r = parseFloat(s[c]), u.push(r), u._firstPT = {
                            _next: u._firstPT,
                            t: u,
                            p: u.length - 1,
                            s: r,
                    ...
                    U = function(t, e, i, s, o, r, c, a, h) {
                        ...
                        if (("number" != typeof f || "number" != typeof s && !d) && (c || isNaN(f) || !d && isNaN(s) || "boolean" == typeof f || "boolean" == typeof s ? (p.fp = c, p = {
                            ...
                            pr: 0,
                            m: 0
                        }) : (p.s = parseFloat(f), d || (p.c = parseFloat(s) - p.s || 0))), p.c) return (p._next = this._firstPT) && (p._next._prev = p),
                        this._firstPT = p,
                        p
                    },
                    j = M._internals = {
                    ...
                    setTimeout(X, 1),
                    x._updateRoot = M.render = function() {
                        var t, e, n;
                    ...
                    Z = function(t, e, n, i) {
                        ...
                        return r && (s = r(t, e, n, i)),
                        (r = M.onOverwrite) && (o = r(t, e, n, i)),
                        !1 !== s && !1 !== o
                    },
                    $ = function(t, e, n, i, s) {
                        var o, r, c, a;
                        if (1 === i || i >= 4) {
                            for (a = s.length, o = 0; o < a; o++) if ((c = s[o]) !== e) c._gc || c._kill(null, t, e) && (r = !0);
                            else if (5 === i) break;
                            return r
                        }
                    ...
                    tt = function(t, e, n) {
                        for (var i = t._timeline,
                        s = i._timeScale,
                        o = t._startTime; i._timeline;) {
                    ...
                    h._init = function() {
                        ...
                        if (r.startAt) {
                            ...
                            if (s.overwrite = !1, s.immediateRender = !0, s.lazy = h && !1 !== r.lazy, s.startAt = s.delay = null, this._startAt = M.to(this.target, 0, s), h) if (this._time > 0) this._startAt = null;
                            else if (0 !== a) return
                        ...
                        this._siblings[t], c ? c[t] : null, t) && (e = !0);
                        else e = this._initProps(this.target, this._propLookup, this._siblings, c, 0);
                        if (e && M._onPluginEvent("_onInitAllProps", this), c && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), r.runBackwards) for (n = this._firstPT; n;) n.s += n.c,
                        n.c = -n.c,
                        n = n._next;
                    ...
                    h._initProps = function(e, n, i, s, o) {
                        ...
                        if (null == e) return ! 1;
                        L[e._gsTweenID] && X(),
                        this.vars.css || e.style && e !== t && e.nodeType && z.css && !1 !== this.vars.autoCSS && R(this.vars, e);
                        for (r in this.vars) if (u = this.vars[r], G[r]) u && (u instanceof Array || u.push && m(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[r] = u = this._swapSelfInParams(u, this));
                            ...
                            c = h._overwriteProps.length; --c > -1;) n[h._overwriteProps[c]] = this._firstPT; (h._priority || h._onInitAllProps) && (a = !0),
                    ...
                    h.render = function(t, e, n) {
                        ...
                        a = this._duration,
                        h = this._rawPrevTime;
                        if (t >= a - 1e-7 && t >= 0) this._totalTime = this._time = a,
                        this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1,
                        this._reversed || (i = !0, s = "onComplete", n = n || this._timeline.autoRemoveChildren),
                        0 === a && (this._initted || !this.vars.lazy || n) && (this._startTime === this._timeline._duration && (t = 0), (h < 0 || t <= 0 && t >= -1e-7 || 1e-10 === h && "isPause" !== this.data) && h !== t && (n = !0, h > 1e-10 && (s = "onReverseComplete")), this._rawPrevTime = r = !e || t || h === t ? t: 1e-10);
                        else if (t < 1e-7) this._totalTime = this._time = 0,
                        this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
                        (0 !== c || 0 === a && h > 0) && (s = "onReverseComplete", i = this._reversed),
                        t < 0 && (this._active = !1, 0 === a && (this._initted || !this.vars.lazy || n) && (h >= 0 && (1e-10 !== h || "isPause" !== this.data) && (n = !0), this._rawPrevTime = r = !e || t || h === t ? t: 1e-10)),
                        this._initted || (n = !0);
                        else if (this._totalTime = this._time = t, this._easeType) {
                            var l = t / a,
                            u = this._easeType,
                            f = this._easePower; (1 === u || 3 === u && l >= .5) && (l = 1 - l),
                            3 === u && (l *= 2),
                            1 === f ? l *= l: 2 === f ? l *= l * l: 3 === f ? l *= l * l * l: 4 === f && (l *= l * l * l * l),
                            this.ratio = 1 === u ? 1 - l: 2 === u ? l: t / a < .5 ? l / 2 : 1 - l / 2
                        } else this.ratio = this._ease.getRatio(t / a);
                        if (this._time !== c || n) {
                            if (!this._initted) {
                                if (this._init(), !this._initted || this._gc) return;
                                if (!n && this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration)) return this._time = this._totalTime = c,
                                this._rawPrevTime = h,
                                E.push(this),
                                void(this._lazy = [t, e]);
                            ...
                            for (!1 !== this._lazy && (this._lazy = !1), this._active || !this._paused && this._time !== c && t >= 0 && (this._active = !0), 0 === c && (this._startAt && (t >= 0 ? this._startAt.render(t, e, n) : s || (s = "_dummyGS")), this.vars.onStart && (0 === this._time && 0 !== a || e || this._callback("onStart"))), o = this._firstPT; o;) o.f ? o.t[o.p](o.c * this.ratio + o.s) : o.t[o.p] = o.c * this.ratio + o.s,
                            o = o._next;
                            this._onUpdate && (t < 0 && this._startAt && -1e-4 !== t && this._startAt.render(t, e, n), e || (this._time !== c || i || n) && this._callback("onUpdate")),
                            s && (this._gc && !n || (t < 0 && this._startAt && !this._onUpdate && -1e-4 !== t && this._startAt.render(t, e, n), i && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[s] && this._callback(s), 0 === a && 1e-10 === this._rawPrevTime && 1e-10 !== r && (this._rawPrevTime = 0)))
                        }
                    },
                    h._kill = function(t, e, i) {
                        ...
                        if ((m(e) || F(e)) && "number" != typeof e[0]) for (s = e.length; --s > -1;) this._kill(t, e[s], i) && (h = !0);
                        else {
                            if (this._targets) {
                                for (s = this._targets.length; --s > -1;) if (e === this._targets[s]) {
                                    a = this._propLookup[s] || {},
                                    this._overwrittenProps = this._overwrittenProps || [],
                                    o = this._overwrittenProps[s] = t ? this._overwrittenProps[s] || {}: "all";
                                    break
                                }
                            } else {
                            ...
                            if (a) {
                                ...
                                for (r in l)(c = a[r]) && (d && (c.f ? c.t[c.p](c.s) : c.t[c.p] = c.s, h = !0), c.pg && c.t._kill(l) && (h = !0), c.pg && 0 !== c.t._overwriteProps.length || (c._prev ? c._prev._next = c._next: c === this._firstPT && (this._firstPT = c._next), c._next && (c._next._prev = c._prev), c._next = c._prev = null), delete a[r]),
                                u && (o[r] = 1); ! this._firstPT && this._initted && this._enabled(!1, !1)
                            }
                        }
                        return h
                    },
                    ...
                    h._enabled = function(t, e) {
                        if (u || l.wake(), t && this._gc) {
                            ...
                            if (i) for (n = i.length; --n > -1;) this._siblings[n] = Q(i[n], this, !0);
                    ...
                    if (h = et.prototype, et.version = "1.19.0", et.API = 2, h._firstPT = null, h._addTween = U, h.setRatio = O, h._kill = function(t) {
                        ...
                        for (; i;) null != t[i.n] && (i._next && (i._next._prev = i._prev), i._prev ? (i._prev._next = i._next, i._prev = null) : this._firstPT === i && (this._firstPT = i._next)),
                        i = i._next;
                        return ! 1
                    },
                    h._mod = h._roundProps = function(t) {
                        for (var e, n = this._firstPT; n;)(e = t[this._propName] || null != n.n && t[n.n.split(this._propName + "_").join("")]) && "function" == typeof e && (2 === n.f ? n.t._applyPT.m = e: n.m = e),
                        n = n._next
                    },
                    M._onPluginEvent = function(t, e) {
                        ...
                        if ("_onInitAllProps" === t) {
                            for (; c;) {
                                for (r = c._next, i = s; i && i.pr > c.pr;) i = i._next; (c._prev = i ? i._prev: o) ? c._prev._next = c: s = c,
                                (c._next = i) ? i._prev = c: o = c,
                                c = r
                            }
                            c = e._firstPT = s
                        }
                        for (; c;) c.pg && "function" == typeof c.t[t] && c.t[t]() && (n = !0),
                        c = c._next;
                        return n
                    },
                    ...
                    _.plugin = function(t) {
                        ...
                        r = b("plugins." + n.charAt(0).toUpperCase() + n.substr(1) + "Plugin",
                        function() {
                            et.call(this, n, i),
            ...
            } (void 0 !== e && e.exports && void 0 !== t ? t: window),
            cc._RF.pop()
        }).call(this, "undefined" != typeof global ? global: "undefined" != typeof self ? self: "undefined" != typeof window ? window: {})
    },
    {}],
    UserInfoWinChild: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "27d86DKpzVCXqCj4AYZBITz", "UserInfoWinChild"),
        cc.Class({
            extends: cc.Component,
            properties: {
                lblName: cc.EditBox,
            ...
            onLoad: function() {},
            onEnable: function() {
                this.globnum = this.lblfree.node.getChildByName("globnum"),
                this.glob = this.lblfree.node.getChildByName("glob"),
                0 == cc.yqs.userMgr.RenameCount ? (this.lblfree.string = "本次修改免费", this.globnum.active = !1, this.glob.active = !1) : (this.lblfree.string = "本次修改花费", this.globnum.active = !0, this.glob.active = !0)
            },
            btnqueding: function() {
                var t = "";
                "" == this.lblName.string ? (cc.yqs.alert.show("", "名字不能为空"), cc.yqs.userMgr.RenameCount--) : this.globnum.active ? this.globnum.active && cc.yqs.userMgr.gems >= 1 ? (t = this.lblName.string, cc.yqs.Hall.lblName.string = t, cc.yqs.UsrInfoWin.lblName.string = t, cc.yqs.userMgr.reName(t, 1), cc.yqs.userMgr.gems--, cc.yqs.alert.show("", "修改成功")) : this.globnum.active && cc.yqs.userMgr.gems < 1 && (cc.yqs.Hall.lblGems.string = "", cc.yqs.alert.show("", "修改失败，金币不足")) : (t = this.lblName.string, cc.yqs.Hall.lblName.string = t, cc.yqs.UsrInfoWin.lblName.string = t, cc.yqs.userMgr.reName(t, 0), cc.yqs.alert.show("", "修改成功")),
                console.log("修改的次数" + cc.yqs.userMgr.RenameCount),
                console.log("游戏币" + cc.yqs.userMgr.gems),
                cc.yqs.userMgr.RenameCount++,
                cc.yqs.Hall.lblGems.string = cc.yqs.userMgr.gems + ".000",
                this.node.active = !1
            },
            btnBack: function() {
                this.node.active = !1
    ...
    UserInfoWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "2f0bfD1eEdDbZ2Oy9CrDHFQ", "UserInfoWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node,
            ...
            onLoad: function() {
                cc.yqs.UsrInfoWin = this,
                this.lblName.string = cc.yqs.userMgr.userName,
                this.lblAccount.string = cc.yqs.userMgr.account,
                this.daojunum.string = cc.yqs.userMgr.item.ice
            },
            onEnable: function() {
                this.commonBg.scale = .2;
                var t = cc.scaleTo(.2, 1.2),
    ...
    UserMgr: [function(t, e, n) {
        ...
        cc.Class({
            ...
            guestAuth: function() {
                ...
                null == t && (t = cc.sys.localStorage.getItem("account")),
                null == t && (t = Date.now(), cc.sys.localStorage.setItem("account", t)),
                cc.yqs.http.sendRequest("/guest", {
                    account: t
                },
                this.onAuth)
            },
            ...
            login: function() {
                var t = this;
                cc.yqs.wc.show("正在登录游戏"),
                cc.yqs.http.sendRequest("/login", {
            ...
            create: function(t) {
                ...
                cc.yqs.http.sendRequest("/create_user", n,
                function(t) {
            ...
            reName: function(t, e) {
                ...
                n.sign = i.md5(this.userId + t + n.gems),
                cc.yqs.http.sendRequest("/rename_user", n,
                function(t) {})
            },
            enterRoom: function(t, e) {
                ...
                cc.yqs.wc.show("正在进入房间 " + t),
                cc.yqs.http.sendRequest("/enter_private_room", i,
                function(i) {
            ...
            enterPublicRoom: function(t, e) {
                ...
                cc.yqs.http.sendRequest("/enter_public_room", i,
                function(t) {
            ...
            getHistoryList: function(t) {
                ...
                cc.yqs.http.sendRequest("/get_history_list", e,
                function(e) {
            ...
            getGamesOfRoom: function(t, e) {
                ...
                cc.yqs.http.sendRequest("/get_games_of_room", n,
                function(t) {
            ...
            getDetailOfGame: function(t, e, n) {
                ...
                cc.yqs.http.sendRequest("/get_detail_of_game", i,
                function(t) {
    ...
    Utils: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "4e9a7iZTuZLtK5Bqz2Hu3Pg", "Utils"),
        cc.Class({
            extends: cc.Component,
            properties: {},
            addClickEvent: function(t, e, n, i) {
                ...
                s.component = n,
                s.handler = i,
                t.getComponent(cc.Button).clickEvents.push(s)
            },
            addSlideEvent: function(t, e, n, i) {
                ...
                s.component = n,
                s.handler = i,
                t.getComponent(cc.Slider).slideEvents.push(s)
            },
            ...
            transString: function(t) {
                var e = t.toString();
                return (e = (e = e.replace("+", "/")).replace("币", ":")).replace(".", ";")
            },
    ...
    WaitingConnection: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "618d6XNdn9JY7RvLKAaquUn", "WaitingConnection"),
        cc.Class({
            extends: cc.Component,
            properties: {
                target: cc.Node,
            ...
            show: function(t) {
                ...
                this.lblContent && (null == t && (t = ""), this.lblContent.string = t)
            },
            hide: function() {
                this._isShow = !1,
                this.node && (this.node.active = this._isShow)
    ...
    XiaoxiWin: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "be1b0JuRU5E5oOe/6JZr6jj", "XiaoxiWin"),
        cc.Class({
            extends: cc.Component,
            properties: {
                commonBg: cc.Node
    ...
    bomb: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "43badzRjsRE3L6vv2DxM6Dq", "bomb"),
        cc.Class({
            extends: cc.Component,
            properties: {
                gold: {
            ...
            numberUpdate: function() {
                j -= .001,
                console.log("@@@@@@@@@@@@@@@@@@@@@@@@" + j + "@@@@@@@" + i + "@@@@@@@@@@@@@@@@@@@@@@@@@"),
                this.gold.string = cc.yqs.utils.transString(j.toFixed(3)) + ":"
            },
            playbomb: function(t) {
                var t = parseFloat(t);
    ...
    coinText: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "a6c7bvVngxNHJC154GAWS4Y", "coinText"),
        cc.Class({
            extends: cc.Component,
            properties: {
                kind: {
            ...
            initWithKind: function(t, e, n) {
                if (null != n) {
                    this.node.getComponent(cc.Label).string = cc.yqs.utils.transString(e),
                    this.node.parent = n.parent,
                    this.node.setLocalZOrder(300),
                    this.node.position = n.position,
                    this.kind = t;
            ...
            putCoinTextToPool: function() {
                ...
                cc.yqs.nodepool.putCoinTextById(t.node, t.kind)
            }
        }),
        cc._RF.pop()
    },
    {}],
    crypto: [function(t, e, n) { (function(i) {
            "use strict";
    ...
    kor: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "745db7TA4FAFokni5dIIR2p", "kor"),
        window.i18n || (window.i18n = {}),
        window.i18n.languages || (window.i18n.languages = {}),
        window.i18n.languages.kor = {
            hello: "你好！",
            bye: "再见！"
        },
        cc._RF.pop()
    ...
    myMd5: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "a36f9gbmoRBN7apzW3P7bGH", "myMd5"),
        cc.md5Encode = function(t) {
            function e(t) {
                try {
                    console.log(t)
                } catch(t) {}
            ...
            function h(t) {
                for (var e = [], n = 0; n < t.length; n++) if (t.charCodeAt(n) <= 127) e.push(t.charCodeAt(n));
                else for (var i = encodeURIComponent(t.charAt(n)).substr(1).split("%"), s = 0; s < i.length; s++) e.push(parseInt(i[s], 16));
                return e
            }
            function l(t, e) {
            ...
            if ("string" == typeof t) u = h(t);
                ...
                if (t.constructor != Array) return e("input data type mismatch"),
                null;
                if (0 === t.length) u = t;
                    ...
                    if ("number" != typeof t[0]) return e("input data type mismatch"),
                    null;
                    u = t
                }
            }
            ...
            u = u.concat(function(t) {
                for (var e = [], n = 0; n < 8; n++) e.push(255 & t),
                t >>>= 8;
                return e
            } (8 * f));
            var g = 1732584193,
            ...
            k = function(t, e, n, s) {
                ...
                w = C,
                C = b,
                b = l(b, i(l(_, l(t, l(e, n))), s)),
                _ = o
            };
            for (p = 0; p < u.length / 64; p++) {
                _ = g;
                var T = 64 * p;
                k(s(b = m, C = y, w = v), 3614090360, a(u, T), 7),
                k(s(b, C, w), 3905402710, a(u, T + 4), 12),
                k(s(b, C, w), 606105819, a(u, T + 8), 17),
                k(s(b, C, w), 3250441966, a(u, T + 12), 22),
                k(s(b, C, w), 4118548399, a(u, T + 16), 7),
                k(s(b, C, w), 1200080426, a(u, T + 20), 12),
                k(s(b, C, w), 2821735955, a(u, T + 24), 17),
                k(s(b, C, w), 4249261313, a(u, T + 28), 22),
                k(s(b, C, w), 1770035416, a(u, T + 32), 7),
                k(s(b, C, w), 2336552879, a(u, T + 36), 12),
                k(s(b, C, w), 4294925233, a(u, T + 40), 17),
                k(s(b, C, w), 2304563134, a(u, T + 44), 22),
                k(s(b, C, w), 1804603682, a(u, T + 48), 7),
                k(s(b, C, w), 4254626195, a(u, T + 52), 12),
                k(s(b, C, w), 2792965006, a(u, T + 56), 17),
                k(s(b, C, w), 1236535329, a(u, T + 60), 22),
                k(o(b, C, w), 4129170786, a(u, T + 4), 5),
                k(o(b, C, w), 3225465664, a(u, T + 24), 9),
                k(o(b, C, w), 643717713, a(u, T + 44), 14),
                k(o(b, C, w), 3921069994, a(u, T), 20),
                k(o(b, C, w), 3593408605, a(u, T + 20), 5),
                k(o(b, C, w), 38016083, a(u, T + 40), 9),
                k(o(b, C, w), 3634488961, a(u, T + 60), 14),
                k(o(b, C, w), 3889429448, a(u, T + 16), 20),
                k(o(b, C, w), 568446438, a(u, T + 36), 5),
                k(o(b, C, w), 3275163606, a(u, T + 56), 9),
                k(o(b, C, w), 4107603335, a(u, T + 12), 14),
                k(o(b, C, w), 1163531501, a(u, T + 32), 20),
                k(o(b, C, w), 2850285829, a(u, T + 52), 5),
                k(o(b, C, w), 4243563512, a(u, T + 8), 9),
                k(o(b, C, w), 1735328473, a(u, T + 28), 14),
                k(o(b, C, w), 2368359562, a(u, T + 48), 20),
                k(r(b, C, w), 4294588738, a(u, T + 20), 4),
                k(r(b, C, w), 2272392833, a(u, T + 32), 11),
                k(r(b, C, w), 1839030562, a(u, T + 44), 16),
                k(r(b, C, w), 4259657740, a(u, T + 56), 23),
                k(r(b, C, w), 2763975236, a(u, T + 4), 4),
                k(r(b, C, w), 1272893353, a(u, T + 16), 11),
                k(r(b, C, w), 4139469664, a(u, T + 28), 16),
                k(r(b, C, w), 3200236656, a(u, T + 40), 23),
                k(r(b, C, w), 681279174, a(u, T + 52), 4),
                k(r(b, C, w), 3936430074, a(u, T), 11),
                k(r(b, C, w), 3572445317, a(u, T + 12), 16),
                k(r(b, C, w), 76029189, a(u, T + 24), 23),
                k(r(b, C, w), 3654602809, a(u, T + 36), 4),
                k(r(b, C, w), 3873151461, a(u, T + 48), 11),
                k(r(b, C, w), 530742520, a(u, T + 60), 16),
                k(r(b, C, w), 3299628645, a(u, T + 8), 23),
                k(c(b, C, w), 4096336452, a(u, T), 6),
                k(c(b, C, w), 1126891415, a(u, T + 28), 10),
                k(c(b, C, w), 2878612391, a(u, T + 56), 15),
                k(c(b, C, w), 4237533241, a(u, T + 20), 21),
                k(c(b, C, w), 1700485571, a(u, T + 48), 6),
                k(c(b, C, w), 2399980690, a(u, T + 12), 10),
                k(c(b, C, w), 4293915773, a(u, T + 40), 15),
                k(c(b, C, w), 2240044497, a(u, T + 4), 21),
                k(c(b, C, w), 1873313359, a(u, T + 32), 6),
                k(c(b, C, w), 4264355552, a(u, T + 60), 10),
                k(c(b, C, w), 2734768916, a(u, T + 24), 15),
                k(c(b, C, w), 1309151649, a(u, T + 52), 21),
                k(c(b, C, w), 4149444226, a(u, T + 16), 6),
                k(c(b, C, w), 3174756917, a(u, T + 44), 10),
                k(c(b, C, w), 718787259, a(u, T + 8), 15),
                k(c(b, C, w), 3951481745, a(u, T + 36), 21),
                g = l(g, _),
                m = l(m, b),
                y = l(y, C),
                v = l(v, w)
    ...
    "polyglot.min": [function(t, e, n) {
        ...
        function(t) {
            ...
            function o(t, e, n) {
                var i, o, r;
                return null != n && t ? (o = t.split(u), r = o[c(e, n)] || o[0], i = s(r)) : i = t,
                i
            }
            function r(t) {
                var e = n(d);
            ...
            e.prototype.t = function(t, e) {
                ...
                "string" == typeof this.phrases[t] ? n = this.phrases[t] : "string" == typeof e._ ? n = e._: this.allowMissing ? n = t: (this.warn('Missing translation for key: "' + t + '"'), i = t),
                "string" == typeof n && (e = l(e), i = o(n, this.currentLocale, e.smart_count), i = a(i, e)),
                i
            },
    ...
    setAvatarWin: [function(t, e, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                for (var t = cc.yqs.userMgr.headimg - 1,
                e = 0; e < this.avatars.length; e++) this.avatars[e].isChecked = t == e
            },
            onEnable: function() {
                this.commonBg.scale = .2;
                var t = cc.scaleTo(.2, 1.2),
            ...
            onAvatarClick: function(t) {
                ...
                var e = this;
                0 == cc.yqs.userMgr.ReHeadCount ? (console.log("=========toggle==========" + t + "====================="), cc.yqs.alert.show("更换头像", "本次更改免费，确定更换头像？",
                function() {
                    var n = e.avatars.indexOf(t);
                    cc.sys.localStorage.setItem("Avatar", n + 1),
                    cc.yqs.eventCenter.emitCustomEvent("setAvatar", n + 1);
                    var s = {
                        userId: cc.yqs.userMgr.userId,
                        index: n + 1,
                        gems: 0
                    ...
                    c = s.gems.toString();
                    s.sign = i.md5(o + r + c),
                    cc.yqs.http.sendRequest("/setAvatar", s)
                },
                !0)) : cc.yqs.userMgr.ReHeadCount > 0 && cc.yqs.userMgr.gems >= 1 ? cc.yqs.alert.show("更换头像", "本次更改需要花费1币，确定更换头像？",
                function() {
                    var n = e.avatars.indexOf(t);
                    cc.yqs.userMgr.coins--,
                    cc.sys.localStorage.setItem("Avatar", n + 1),
                    cc.yqs.eventCenter.emitCustomEvent("setAvatar", n + 1);
                    var s = {
                        userId: cc.yqs.userMgr.userId,
                ...
                !0) : cc.yqs.userMgr.ReHeadCount > 0 && cc.yqs.userMgr.gems < 1 && cc.yqs.alert.show("更换头像", "更换失败，金币不足"),
                cc.yqs.userMgr.ReHeadCount++
            },
            onBack: function() {
                var t = cc.scaleTo(.1, 1.2),
                e = cc.scaleTo(.2, .6),
    ...
    "socket-io": [function(t, e, n) { (function(i) {
            ...
            function(t) {
                ...
                else { ("undefined" != typeof window ? window: void 0 !== i ? i: "undefined" != typeof self ? self: this).io = t()
                }
            } (function() {
                return function e(n, i, s) {
                    ...
                    3 : [function(t, e, n) { (function(n) {
                            function i(t, e) {
                                if (! (this instanceof i)) return new i(t, e);
                                e = e || {},
                                t && "object" == (void 0 === t ? "undefined": s(t)) && (e = t, t = null),
                                ...
                                function e() {
                                    ...
                                    function(e) {
                                        if (!u) if ("pong" == e.type && "probe" == e.data) {
                                            ...
                                            i.priorWebsocketSuccess = "websocket" == l.name,
                            ...
                            i.prototype.sendPacket = function(t, e, n, i) {
                                if ("function" == typeof e && (i = e, e = void 0), "function" == typeof n && (i = n, n = null), "closing" != this.readyState && "closed" != this.readyState) { (n = n || {}).compress = !1 !== n.compress;
                                    var s = {
                                        type: t,
                                        data: e,
                                        options: n
                    ...
                    5 : [function(t, e, n) { (function(e) {
                            ...
                            n.polling = function(t) {
                                ...
                                if (e.location) {
                                    ...
                                    h = location.port;
                                    h || (h = a ? 443 : 80),
                                    n = t.hostname != location.hostname || h != t.port,
                                    r = t.secure != a
                                }
                    ...
                    6 : [function(t, e, n) { (function(n) {
                            ...
                            s.prototype.doWrite = function(t, e) {
                                ...
                                function i() {
                                    ...
                                    } catch(t) { (o = document.createElement("iframe")).name = s.iframeId,
                                        o.src = "javascript:0"
                                    }
                                    o.id = s.iframeId,
                    ...
                    7 : [function(t, e, n) { (function(n) {
                            ...
                            n.document && (o.requestsCount = 0, o.requests = {},
                            n.attachEvent ? n.attachEvent("onunload", r) : n.addEventListener && n.addEventListener("beforeunload", r, !1))
                        }).call(this, "undefined" != typeof self ? self: "undefined" != typeof window ? window: void 0 !== i ? i: {})
                    },
                    {
                        "./polling": 8,
                    ...
                    8 : [function(t, e, n) {
                        ...
                        i.prototype.pause = function(t) {
                            ...
                            if (this.readyState = "pausing", this.polling || !this.writable) {
                                var i = 0;
                                this.polling && (h("we are currently polling - waiting to pause"), i++, this.once("pollComplete",
                                function() {
                                    h("pre-pause polling complete"),
                                    --i || e()
                                })),
                                this.writable || (h("we are currently writing - waiting to pause"), i++, this.once("drain",
                                function() {
                        ...
                        i.prototype.onData = function(t) {
                            ...
                            r.decodePayload(t, this.socket.binaryType,
                            function(t, n, i) {
                        ...
                        i.prototype.write = function(t) {
                            ...
                            n = this;
                            r.encodePayload(t, this.supportsBinary,
                            function(t) {
                                n.doWrite(t, e)
                            })
                        },
                    ...
                    9 : [function(t, e, n) { (function(n) {
                            ...
                            i.prototype.doOpen = function() {
                                if (this.check()) {
                                    ...
                                    this.ws = l ? new u(t) : new u(t, void 0, e),
                            ...
                            i.prototype.write = function(t) {
                                ...
                                c = s; r < c; r++) !
                                function(t) {
                                    o.encodePacket(t, i.supportsBinary,
                                    function(o) {
                                        if (!l) {
                                            var r = {};
                                            t.options && (r.compress = t.options.compress),
                                            i.perMessageDeflate && ("string" == typeof o ? n.Buffer.byteLength(o) : o.length) < i.perMessageDeflate.threshold && (r.compress = !1)
                                        }
                                        try {
                    ...
                    11 : [function(t, e, n) {
                        ...
                        e.exports = function(t, e, n) {
                            function s(t, i) {
                                ...
                                t ? (o = !0, e(t), e = n) : 0 !== s.count || o || e(null, i)
                            }
                            var o = !1;
                            return n = n || i,
                            s.count = t,
                    ...
                    13 : [function(t, e, n) { !
                        function(t) {
                            ...
                            n.decode = function(e) {
                                ...
                                u = new Uint8Array(l);
                                for (n = 0; n < a; n += 4) i = t.indexOf(e[n]),
                                s = t.indexOf(e[n + 1]),
                                o = t.indexOf(e[n + 2]),
                                r = t.indexOf(e[n + 3]),
                                u[h++] = i << 2 | s >> 4,
                                ...
                                for (var e = 0; e < t.length; e++) {
                                    ...
                                    if (n.buffer instanceof ArrayBuffer) {
                                        ...
                                        if (n.byteLength !== i.byteLength) {
                                            ...
                                            s.set(new Uint8Array(i, n.byteOffset, n.byteLength)),
                                            i = s.buffer
                                        }
                                        t[e] = i
                                    }
                    ...
                    15 : [function(t, e, n) {
                        ...
                        i.prototype.emit = function(t) {
                            ...
                            n = this._callbacks[t];
                            if (n) for (var i = 0,
                            s = (n = n.slice(0)).length; i < s; ++i) n[i].apply(this, e);
                            return this
                        },
                    ...
                    17 : [function(t, e, n) {
                        ...
                        n.formatArgs = function() {
                            ...
                            s = 0,
                            o = 0;
                            return (t = [t[0], i, "color: inherit"].concat(Array.prototype.slice.call(t, 1)))[0].replace(/%[a-z%]/g,
                            function(t) {
                                "%%" !== t && (s++, "%c" === t && (o = s))
                            }),
                            t.splice(o, 0, i),
                    ...
                    18 : [function(t, e, n) {
                        function i() {
                            ...
                            function o() {
                                ...
                                "function" == typeof n.formatArgs && (c = n.formatArgs.apply(t, c)),
                                (o.log || n.log || console.log.bind(console)).apply(t, c)
                            }
                            e.enabled = !1,
                            o.enabled = !0;
                    ...
                    19 : [function(t, e, n) { (function(e) {
                            ...
                            function r(t, e, i) {
                                ...
                                return s[0] = y[t.type],
                                i(new b([s.buffer, t.data]))
                            }
                            function c(t, e, n) {
                                for (var i = new Array(t.length), s = f(t.length, n), o = 0; o < t.length; o++) !
                                function(t, n, s) {
                                    e(n,
                                    function(e, n) {
                                        i[t] = n,
                            ...
                            n.encodePacket = function(t, n, o, c) {
                                ...
                                var h = y[t.type];
                                return void 0 !== t.data && (h += o ? d.encode(String(t.data)) : String(t.data)),
                                c("" + h)
                            },
                            ...
                            n.encodePayload = function(t, e, i) {
                                ...
                                var o = h(t);
                                return e && o ? b && !m ? n.encodePayloadAsBlob(t, i) : n.encodePayloadAsArrayBuffer(t, i) : t.length ? void c(t,
                                function(t, i) {
                                    n.encodePacket(t, !!o && e, !0,
                                    function(t) {
                                        i(null, s(t))
                                    })
                                },
                    ...
                    25 : [function(t, e, n) {
                        ...
                        e.exports = function(t, e) {
                            return e = e || {},
                            "string" == typeof t ? i(t) : e.long ? o(t) : s(t)
                        }
                    },
                    {}],
                    26 : [function(t, e, n) { (function(t) {
                            var n = /^[\],:{}\s]*$/,
                    ...
                    27 : [function(t, e, n) {
                        ...
                        n.decode = function(t) {
                            for (var e = {},
                            n = t.split("&"), i = 0, s = n.length; i < s; i++) {
                                var o = n[i].split("=");
                    ...
                    28 : [function(t, e, n) {
                        ...
                        e.exports = function(t) {
                            ...
                            for (var r = i.exec(t || ""), c = {},
                            a = 14; a--;) c[s[a]] = r[a] || "";
                            return - 1 != n && -1 != o && (c.source = e, c.host = c.host.substring(1, c.host.length - 1).replace(/;/g, ":"), c.authority = c.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), c.ipv6uri = !0),
                            c
                        }
                    },
                    {}],
                    29 : [function(t, e, n) { (function(t) { !
                            function(i) {
                                function o(t) {
                                ...
                                function r(t) {
                                    for (var e, n = t.length,
                                    i = -1,
                                    s = ""; ++i < n;)(e = t[i]) > 65535 && (s += v((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e),
                                    s += v(e);
                                    return s
                                }
                                function c(t) {
                                ...
                                function h(t) {
                                    ...
                                    var e = "";
                                    return 0 == (4294965248 & t) ? e = v(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (c(t), e = v(t >> 12 & 15 | 224), e += a(t, 6)) : 0 == (4292870144 & t) && (e = v(t >> 18 & 7 | 240), e += a(t, 12), e += a(t, 6)),
                                    e += v(63 & t | 128)
                                }
                                function l() {
                                ...
                                function u() {
                                    ...
                                    if (224 == (240 & t)) {
                                        if (e = l(), n = l(), (s = (15 & t) << 12 | e << 6 | n) >= 2048) return c(s),
                                        s;
                                        throw Error("Invalid continuation byte")
                                    }
                                ...
                                if (f && !f.nodeType) if (d) d.exports = _;
                                else {
                    ...
                    30 : [function(t, e, n) {
                        ...
                        for (var o, r = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), c = 64, a = {},
                        h = 0, l = 0; l < c; l++) a[r[l]] = l;
                        s.encode = i,
                        s.decode = function(t) {
                            var e = 0;
                    ...
                    31 : [function(t, e, n) {
                        function i(t, e) {
                            ...
                            u = i.path,
                            f = h[l] && u in h[l].nsps;
                            return e.forceNew || e["force new connection"] || !1 === e.multiplex || f ? (a("ignoring socket cache for %s", r), n = c(r, e)) : (h[l] || (a("new io instance for %s", r), h[l] = c(r, e)), n = h[l]),
                            n.socket(i.path)
                        }
                        var o = t("./url"),
                    ...
                    32 : [function(t, e, n) {
                        function i(t, e) {
                            if (! (this instanceof i)) return new i(t, e);
                            t && "object" == (void 0 === t ? "undefined": s(t)) && (e = t, t = void 0),
                        ...
                        i.prototype.onopen = function() {
                            ...
                            this.emit("open");
                            var t = this.engine;
                            this.subs.push(h(t, "data", l(this, "ondata"))),
                            this.subs.push(h(t, "ping", l(this, "onping"))),
                            this.subs.push(h(t, "pong", l(this, "onpong"))),
                            this.subs.push(h(t, "error", l(this, "onerror"))),
                            this.subs.push(h(t, "close", l(this, "onclose"))),
                            this.subs.push(h(this.decoder, "decoded", l(this, "ondecoded")))
                        },
                        ...
                        i.prototype.socket = function(t) {
                            function e() {~f(i.connecting, n) || i.connecting.push(n)
                            }
                            var n = this.nsps[t];
                            if (!n) {
                                n = new r(this, t),
                    ...
                    34 : [function(t, e, n) {
                        ...
                        i.prototype.emit = function(t) {
                            if (u.hasOwnProperty(t)) return f.apply(this, arguments),
                            this;
                            var e = r(arguments),
                            n = s.EVENT;
                            ...
                            "function" == typeof e[e.length - 1] && (h("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e.pop(), i.id = this.ids++),
                        ...
                        i.prototype.onopen = function() {
                            h("transport is open - connecting"),
                        ...
                        i.prototype.onevent = function(t) {
                            ...
                            null != t.id && (h("attaching ack callback to event"), e.push(this.ack(t.id))),
                    ...
                    35 : [function(t, e, n) { (function(n) {
                            ...
                            e.exports = function(t, e) {
                                ...
                                "string" == typeof t && ("/" == t.charAt(0) && (t = "/" == t.charAt(1) ? e.protocol + t: e.host + t), /^(https?|wss?):\/\//.test(t) || (s("protocol-less url %s", t), t = void 0 !== e ? e.protocol + "//" + t: "https://" + t), s("parse %s", t), o = i(t)),
                                o.port || (/^(http|ws)$/.test(o.protocol) ? o.port = "80": /^(http|ws)s$/.test(o.protocol) && (o.port = "443")),
                                o.path = o.path || "/";
                                var r = -1 !== o.host.indexOf(":") ? "[" + o.host + "]": o.host;
                                return o.id = o.protocol + "://" + r + ":" + o.port,
                                o.href = o.protocol + "://" + r + (e && e.port == o.port ? "": ":" + o.port),
                                o
                            }
                        }).call(this, "undefined" != typeof self ? self: "undefined" != typeof window ? window: void 0 !== i ? i: {})
                    },
                            ...
                            n.removeBlobs = function(t, n) {
                                function r(t, h, l) {
                                    ...
                                    if (e.Blob && t instanceof Blob || e.File && t instanceof File) {
                                        ...
                                        u.onload = function() {
                                            l ? l[h] = this.result: a = this.result,
                                            --c || n(a)
                                        },
                                        u.readAsArrayBuffer(t)
                                    } else if (i(t)) for (var f = 0; f < t.length; f++) r(t[f], f, t);
                                    else if (t && "object" == (void 0 === t ? "undefined": s(t)) && !o(t)) for (var d in t) r(t[d], d, t)
                                }
                                var c = 0,
                                a = t;
                                r(a),
                    ...
                    47 : [function(t, e, n) {
                        ...
                        function s(t) {
                            ...
                            null != t.data && (i && (e += ","), e += u.stringify(t.data)),
                        ...
                        function c(t) {
                            ...
                            if ("/" == t.charAt(i + 1)) for (e.nsp = ""; ++i && "," != (r = t.charAt(i)) && (e.nsp += r, i != t.length););
                            else e.nsp = "/";
                            var o = t.charAt(i + 1);
                            if ("" !== o && Number(o) == o) {
                                for (e.id = ""; ++i;) {
                        ...
                        i.prototype.encode = function(t, e) {
                            ...
                            n.BINARY_EVENT == t.type || n.BINARY_ACK == t.type ? o(t, e) : e([s(t)])
                        },
                        f(r.prototype),
                        r.prototype.add = function(t) {
                            var e;
                            if ("string" == typeof t) e = c(t),
                            n.BINARY_EVENT == e.type || n.BINARY_ACK == e.type ? (this.reconstructor = new a(e), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", e)) : this.emit("decoded", e);
                            else {
                                if (!p(t) && !t.base64) throw new Error("Unknown type: " + t);
                                if (!this.reconstructor) throw new Error("got binary data when not reconstructing a packet"); (e = this.reconstructor.takeBinaryData(t)) && (this.reconstructor = null, this.emit("decoded", e))
                            }
                        },
                    ...
                    50 : [function(t, e, n) { (function(t) { (function() {
                                function i(t, e) {
                                    function n(t) {
                                        if (n[t] !== y) return n[t];
                                        var i;
                                    ...
                                    if (!n("json")) {
                                        ...
                                        if ((g = v.hasOwnProperty) || (g = function(t) {
                                            ...
                                            function(t, e) {
                                                ...
                                                for (n in t) s && "prototype" == n || !g.call(t, n) || (i = "constructor" === n) || e(n); (i || g.call(t, n = "constructor")) && e(n)
                                        ...
                                        !n("json-stringify")) {
                                            ...
                                            P = function t(e, n, i, o, r, c, a) {
                                                ...
                                                if ("object" == (void 0 === h ? "undefined": s(h)) && h) if ("[object Date]" != (l = _.call(h)) || g.call(h, "toJSON"))"function" == typeof h.toJSON && ("[object Number]" != l && "[object String]" != l && "[object Array]" != l || g.call(h, "toJSON")) && (h = h.toJSON(e));
                                                else if (h > -1 / 0 && h < 1 / 0) {
                                                    if (T) {
                                                        for (p = w(h / 864e5), u = w(p / 365.2425) + 1970 - 1; T(u + 1, 0) <= p; u++);
                                                        for (d = w((p - T(u, 0)) / 30.42); T(u, d + 1) <= p; d++);
                                                        p = 1 + p - T(u, d),
                                                        b = w((v = (h % 864e5 + 864e5) % 864e5) / 36e5) % 24,
                                                        C = w(v / 6e4) % 60,
                                                        k = w(v / 1e3) % 60,
                                                        A = v % 1e3
                                                ...
                                                if ("object" == (void 0 === h ? "undefined": s(h))) {
                                                    ...
                                                    if (a.push(h), P = [], M = c, c += r, "[object Array]" == l) {
                                                        for (x = 0, I = h.length; x < I; x++) S = t(x, h, i, o, r, c, a),
                                                        P.push(S === y ? "null": S);
                                                        F = P.length ? r ? "[\n" + c + P.join(",\n" + c) + "\n" + M + "]": "[" + P.join(",") + "]": "[]"
                                                    } else m(o || h,
                                                    function(e) {
                                            ...
                                            e.stringify = function(t, e, n) {
                                                var i, r, c, a;
                                                if (o[void 0 === e ? "undefined": s(e)] && e) if ("[object Function]" == (a = _.call(e))) r = e;
                                                else if ("[object Array]" == a) {
                                                    c = {};
                                                    for (var h, l = 0,
                                                    u = e.length; l < u; h = e[l++], ("[object String]" == (a = _.call(h)) || "[object Number]" == a) && (c[h] = 1));
                                                }
                                        ...
                                        if (!n("json-parse")) {
                                            ...
                                            R = function() {
                                                for (var t, e, n, i, s, o = x,
                                                r = o.length; S < r;) switch (s = o.charCodeAt(S)) {
                                                case 9:
                                                case 10:
                                                case 13:
                                                case 32:
                                                ...
                                                case 58:
                                                case 44:
                                                    return t = C ? o.charAt(S) : o[S],
                                                    S++,
                                                    t;
                                                case 34:
                                                    for (t = "@", S++; S < r;) if ((s = o.charCodeAt(S)) < 32) F();
                                                ...
                                                default:
                                                    ...
                                                    if (i && F(), "true" == o.slice(S, S + 4)) return S += 4,
                                                    !0;
                                                    if ("false" == o.slice(S, S + 5)) return S += 5,
                                                    !1;
                                                    if ("null" == o.slice(S, S + 4)) return S += 4,
                                                    null;
                                                    F()
                                                }
                                                return "$"
                                            ...
                                            E = function t(e) {
                                                ...
                                                if ("$" == e && F(), "string" == typeof e) {
                                                    ...
                                                    if ("{" == e) {
                                                        for (n = {};
                                                        "}" != (e = R()); i || (i = !0)) i && ("," == e ? "}" == (e = R()) && F() : F()),
                                                        "," != e && "string" == typeof e && "@" == (C ? e.charAt(0) : e[0]) && ":" == R() || F(),
                                                        n[e.slice(1)] = t(R());
                                                        return n
                                                    }
                                                    F()
                                            ...
                                            N = function(t, e, n) {
                                                var i, o = t[e];
                                                if ("object" == (void 0 === o ? "undefined": s(o)) && o) if ("[object Array]" == _.call(o)) for (i = o.length; i--;) L(o, i, n);
                                                else m(o,
                                                function(t) {
                                                    L(o, t, n)
                                                });
                                            ...
                                            e.parse = function(t, e) {
                                                ...
                                                "$" != R() && F(),
                                                S = x = null,
                                                e && "[object Function]" == _.call(e) ? N((i = {},
                                                i[""] = n, i), "", e) : n
                                            }
                                        }
                                    }
                                ...
                                if (!a || a.global !== a && a.window !== a && a.self !== a || (c = a), r) i(c, r);
                                    ...
                                    f = i(c, c.JSON3 = {
                                        noConflict: function() {
                                            return u || (u = !0, c.JSON = h, c.JSON3 = l, h = l = null),
                                            f
                                        }
                                    });
                                    c.JSON = {
    ...
    zh: [function(t, e, n) {
        "use strict";
        cc._RF.push(e, "77784LRrLtNUZqXof19dK1m", "zh"),
        window.i18n || (window.i18n = {}),
        window.i18n.languages || (window.i18n.languages = {}),
        window.i18n.languages.zh = {
            ...
            key160: "兑换最低金额%s币，兑换后账号内必须剩余至少%s币",
